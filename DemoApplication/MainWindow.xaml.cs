...
namespace DemoApplication
{
    public partial class MainWindow : Window
    {
        #region Fields
            ...
            private WriteableBitmap[] buffers = new WriteableBitmap[2];
            ...
            private Mathematics.Vector3D rotationSpeed = Mathematics.Vector3D.Zero;
            private Mathematics.Vector3D rotation = Mathematics.Vector3D.Zero;
            private Mathematics.Vector3D translation = Mathematics.Vector3D.Zero;
            private Mathematics.Vector3D scale = Mathematics.Vector3D.Unit;

            private Int32Rect bufferRegion = new Int32Rect();
            private Mathematics.Vector4D clearColor = new Mathematics.Vector4D(0.392156899f, 0.584313750f, 0.929411829f, 1.0f);

            private bool isTriangles = false;
            private bool isRotating = true;
            private bool isCulling = true;
        #endregion

        #region Models
            private List<Polygon> primitives = new List<Polygon>();
            private Polygon activePrimitive = null;
        #endregion
        ...
        #region Constructors
            public MainWindow()
            {
                ...
                this.Startup();                
                this.timer = new DispatcherTimer(TimeSpan.FromSeconds(1.0 / 60.0), DispatcherPriority.ApplicationIdle, this.Timer_Tick, Application.Current.Dispatcher);
            }

            private void Startup()
            {
                this.pixelWidth = (int)(this.displaySurface.Width);
                this.pixelHeight = (int)(this.displaySurface.Height);
                this.pixelCount = (this.pixelWidth * this.pixelHeight);

                for (int i = 0; i < this.buffers.Length; i++)
                {
                    this.buffers[i] = new WriteableBitmap(this.pixelWidth, this.pixelHeight, 96.0, 96.0, PixelFormats.Rgba128Float, null);
                }

                this.bufferRegion = new Int32Rect(0, 0, this.pixelWidth, this.pixelHeight);
                this.buffers[this.renderBuffer].Lock();

                this.CreatePrimitives();
                this.primitiveListBox.SelectedIndex = 0;
            ...
            private void Reset()
            {
                this.rotationXSlider.Value = 0.0;
                this.rotationYSlider.Value = 0.0;
                this.rotationZSlider.Value = 0.0;

                this.zoomSlider.Value = 100.0;

                this.renderTriangleCheckBox.IsChecked = false;
                this.rotateModelCheckBox.IsChecked = true;
                this.cullFacesCheckBox.IsChecked = true;
                
                this.rotation = new Mathematics.Vector3D(0.0f, 0.0f, 0.0f);
                this.translation = new Mathematics.Vector3D((this.pixelWidth / 2.0f), (this.pixelHeight / 2.0f), 0.0f);
                this.scale = new Mathematics.Vector3D(100.0f, 100.0f, 1.0f);
            }
            ...
            private void CreateCube()
            {
                ...
                {
                    vertices = new List<Mathematics.Vector3D>()
                    {
                        new Mathematics.Vector3D(-1.000000f, -1.000000f, -1.000000f), 
                        new Mathematics.Vector3D(-1.000000f,  1.000000f, -1.000000f), 
                        new Mathematics.Vector3D( 1.000000f,  1.000000f, -1.000000f), 
                        new Mathematics.Vector3D( 1.000000f, -1.000000f, -1.000000f), 
                        new Mathematics.Vector3D(-1.000000f, -1.000000f,  1.000000f), 
                    ...
                    modifiedVertices = new List<Mathematics.Vector3D>(),

                    normals = new List<Mathematics.Vector3D>()
                    {
                        new Mathematics.Vector3D(-1.000000f,  0.000000f,  0.000000f),
                        new Mathematics.Vector3D( 0.000000f,  1.000000f, -0.000000f),
                        new Mathematics.Vector3D( 1.000000f,  0.000000f, -0.000000f),
                        new Mathematics.Vector3D( 0.000000f, -1.000000f,  0.000000f),
                        new Mathematics.Vector3D(-0.000000f,  0.000000f, -1.000000f),
                        new Mathematics.Vector3D(-0.000000f,  0.000000f,  1.000000f)
                    },
                    ...
                    modifiedNormals = new List<Mathematics.Vector3D>()
                };
                ...
                this.primitiveListBox.Items.Add(item);
            }
            ...
            private void CreateSphere()
            {
                Polygon primitive = new Polygon()
                {
                    vertices = new List<Mathematics.Vector3D>()
                    {
                        new Mathematics.Vector3D(-0.195090f,  0.000000f,  0.980785f),
                        new Mathematics.Vector3D(-0.382683f,  0.000000f,  0.923880f),
                        new Mathematics.Vector3D(-0.555570f,  0.000000f,  0.831470f),
                        new Mathematics.Vector3D(-0.707107f,  0.000000f,  0.707107f),
                        new Mathematics.Vector3D(-0.831470f,  0.000000f,  0.555570f),
                        new Mathematics.Vector3D(-0.923880f,  0.000000f,  0.382683f),
                        new Mathematics.Vector3D(-0.980785f,  0.000000f,  0.195090f),
                        new Mathematics.Vector3D(-1.000000f,  0.000000f,  0.000000f),
                        new Mathematics.Vector3D(-0.980785f,  0.000000f, -0.195090f),
                        new Mathematics.Vector3D(-0.923880f,  0.000000f, -0.382683f),
                        new Mathematics.Vector3D(-0.831470f,  0.000000f, -0.555570f),
                        ...
                        new Mathematics.Vector3D(-0.382683f,  0.000000f, -0.923880f),
                        new Mathematics.Vector3D(-0.195090f,  0.000000f, -0.980785f),
                        new Mathematics.Vector3D(-0.191342f,  0.038060f,  0.980785f),
                        new Mathematics.Vector3D(-0.375330f,  0.074658f,  0.923880f),
                        new Mathematics.Vector3D(-0.544895f,  0.108386f,  0.831470f),
                        new Mathematics.Vector3D(-0.693520f,  0.137950f,  0.707107f),
                        new Mathematics.Vector3D(-0.815493f,  0.162212f,  0.555570f),
                        new Mathematics.Vector3D(-0.906127f,  0.180240f,  0.382683f),
                        new Mathematics.Vector3D(-0.961940f,  0.191342f,  0.195090f),
                        new Mathematics.Vector3D(-0.980785f,  0.195090f,  0.000000f),
                        new Mathematics.Vector3D(-0.961940f,  0.191342f, -0.195090f),
                        new Mathematics.Vector3D(-0.906127f,  0.180240f, -0.382683f),
                        new Mathematics.Vector3D(-0.815493f,  0.162212f, -0.555570f),
                        new Mathematics.Vector3D(-0.693520f,  0.137950f, -0.707107f),
                        new Mathematics.Vector3D(-0.544895f,  0.108386f, -0.831470f),
                        new Mathematics.Vector3D(-0.375330f,  0.074658f, -0.923880f),
                        new Mathematics.Vector3D(-0.191341f,  0.038060f, -0.980785f),
                        new Mathematics.Vector3D(-0.180240f,  0.074658f,  0.980785f),
                        new Mathematics.Vector3D(-0.353553f,  0.146447f,  0.923880f),
                        new Mathematics.Vector3D(-0.513280f,  0.212608f,  0.831470f),
                        new Mathematics.Vector3D(-0.653281f,  0.270598f,  0.707107f),
                        new Mathematics.Vector3D(-0.768178f,  0.318190f,  0.555570f),
                        new Mathematics.Vector3D(-0.853553f,  0.353553f,  0.382683f),
                        new Mathematics.Vector3D(-0.906127f,  0.375330f,  0.195090f),
                        new Mathematics.Vector3D(-0.923880f,  0.382684f,  0.000000f),
                        new Mathematics.Vector3D(-0.906127f,  0.375330f, -0.195090f),
                        new Mathematics.Vector3D(-0.853553f,  0.353554f, -0.382683f),
                        new Mathematics.Vector3D(-0.768178f,  0.318190f, -0.555570f),
                        new Mathematics.Vector3D(-0.653281f,  0.270598f, -0.707107f),
                        new Mathematics.Vector3D(-0.513280f,  0.212608f, -0.831470f),
                        new Mathematics.Vector3D(-0.353553f,  0.146447f, -0.923880f),
                        new Mathematics.Vector3D(-0.180240f,  0.074658f, -0.980785f),
                        new Mathematics.Vector3D(-0.162212f,  0.108387f,  0.980785f),
                        new Mathematics.Vector3D(-0.318190f,  0.212608f,  0.923880f),
                        new Mathematics.Vector3D(-0.461940f,  0.308658f,  0.831470f),
                        new Mathematics.Vector3D(-0.587938f,  0.392848f,  0.707107f),
                        new Mathematics.Vector3D(-0.691342f,  0.461940f,  0.555570f),
                        new Mathematics.Vector3D(-0.768178f,  0.513280f,  0.382683f),
                        new Mathematics.Vector3D(-0.815493f,  0.544895f,  0.195090f),
                        new Mathematics.Vector3D(-0.831470f,  0.555570f,  0.000000f),
                        new Mathematics.Vector3D(-0.815493f,  0.544895f, -0.195090f),
                        new Mathematics.Vector3D(-0.768178f,  0.513280f, -0.382683f),
                        new Mathematics.Vector3D(-0.691342f,  0.461940f, -0.555570f),
                        new Mathematics.Vector3D(-0.587938f,  0.392848f, -0.707107f),
                        new Mathematics.Vector3D(-0.461940f,  0.308658f, -0.831470f),
                        new Mathematics.Vector3D(-0.318189f,  0.212608f, -0.923880f),
                        new Mathematics.Vector3D(-0.162211f,  0.108386f, -0.980785f),
                        new Mathematics.Vector3D(-0.137950f,  0.137950f,  0.980785f),
                        new Mathematics.Vector3D(-0.270598f,  0.270598f,  0.923880f),
                        new Mathematics.Vector3D(-0.392847f,  0.392848f,  0.831470f),
                        new Mathematics.Vector3D(-0.500000f,  0.500000f,  0.707107f),
                        new Mathematics.Vector3D(-0.587938f,  0.587938f,  0.555570f),
                        new Mathematics.Vector3D(-0.653281f,  0.653282f,  0.382683f),
                        new Mathematics.Vector3D(-0.693520f,  0.693520f,  0.195090f),
                        new Mathematics.Vector3D(-0.707107f,  0.707107f,  0.000000f),
                        new Mathematics.Vector3D(-0.693520f,  0.693520f, -0.195090f),
                        new Mathematics.Vector3D(-0.653281f,  0.653282f, -0.382683f),
                        new Mathematics.Vector3D(-0.587938f,  0.587938f, -0.555570f),
                        new Mathematics.Vector3D(-0.500000f,  0.500000f, -0.707107f),
                        new Mathematics.Vector3D(-0.392847f,  0.392848f, -0.831470f),
                        new Mathematics.Vector3D(-0.270598f,  0.270598f, -0.923880f),
                        new Mathematics.Vector3D(-0.137949f,  0.137950f, -0.980785f),
                        new Mathematics.Vector3D(-0.108386f,  0.162212f,  0.980785f),
                        new Mathematics.Vector3D(-0.212607f,  0.318190f,  0.923880f),
                        new Mathematics.Vector3D(-0.308658f,  0.461940f,  0.831470f),
                        new Mathematics.Vector3D(-0.392847f,  0.587938f,  0.707107f),
                        new Mathematics.Vector3D(-0.461940f,  0.691342f,  0.555570f),
                        new Mathematics.Vector3D(-0.513280f,  0.768178f,  0.382683f),
                        new Mathematics.Vector3D(-0.544895f,  0.815493f,  0.195090f),
                        new Mathematics.Vector3D(-0.555570f,  0.831470f,  0.000000f),
                        new Mathematics.Vector3D(-0.544895f,  0.815493f, -0.195090f),
                        new Mathematics.Vector3D(-0.513280f,  0.768178f, -0.382683f),
                        new Mathematics.Vector3D(-0.461940f,  0.691342f, -0.555570f),
                        new Mathematics.Vector3D(-0.392847f,  0.587938f, -0.707107f),
                        ...
                        new Mathematics.Vector3D(-0.212607f,  0.318190f, -0.923880f),
                        new Mathematics.Vector3D(-0.108386f,  0.162212f, -0.980785f),
                        new Mathematics.Vector3D(-0.074658f,  0.180240f,  0.980785f),
                        new Mathematics.Vector3D(-0.146446f,  0.353554f,  0.923880f),
                        new Mathematics.Vector3D(-0.212607f,  0.513280f,  0.831470f),
                        new Mathematics.Vector3D(-0.270598f,  0.653282f,  0.707107f),
                        new Mathematics.Vector3D(-0.318189f,  0.768178f,  0.555570f),
                        new Mathematics.Vector3D(-0.353553f,  0.853554f,  0.382683f),
                        new Mathematics.Vector3D(-0.375330f,  0.906128f,  0.195090f),
                        new Mathematics.Vector3D(-0.382683f,  0.923880f,  0.000000f),
                        new Mathematics.Vector3D(-0.375330f,  0.906128f, -0.195090f),
                        new Mathematics.Vector3D(-0.353553f,  0.853554f, -0.382683f),
                        new Mathematics.Vector3D(-0.318189f,  0.768178f, -0.555570f),
                        new Mathematics.Vector3D(-0.270598f,  0.653282f, -0.707107f),
                        new Mathematics.Vector3D(-0.212607f,  0.513280f, -0.831470f),
                        new Mathematics.Vector3D(-0.146446f,  0.353553f, -0.923880f),
                        new Mathematics.Vector3D(-0.074658f,  0.180240f, -0.980785f),
                        new Mathematics.Vector3D(-0.038060f,  0.191342f,  0.980785f),
                        new Mathematics.Vector3D(-0.074658f,  0.375331f,  0.923880f),
                        new Mathematics.Vector3D(-0.108386f,  0.544895f,  0.831470f),
                        new Mathematics.Vector3D(-0.137949f,  0.693520f,  0.707107f),
                        new Mathematics.Vector3D(-0.162211f,  0.815493f,  0.555570f),
                        new Mathematics.Vector3D(-0.180240f,  0.906128f,  0.382683f),
                        new Mathematics.Vector3D(-0.191341f,  0.961940f,  0.195090f),
                        new Mathematics.Vector3D(-0.195090f,  0.980785f,  0.000000f),
                        new Mathematics.Vector3D(-0.191341f,  0.961940f, -0.195090f),
                        new Mathematics.Vector3D(-0.180240f,  0.906128f, -0.382683f),
                        new Mathematics.Vector3D(-0.162211f,  0.815493f, -0.555570f),
                        new Mathematics.Vector3D(-0.137949f,  0.693520f, -0.707107f),
                        new Mathematics.Vector3D(-0.108386f,  0.544895f, -0.831470f),
                        new Mathematics.Vector3D(-0.074658f,  0.375330f, -0.923880f),
                        new Mathematics.Vector3D(-0.038060f,  0.191342f, -0.980785f),
                        new Mathematics.Vector3D(0.000000f,  0.195091f,  0.980785f),
                        new Mathematics.Vector3D(0.000000f,  0.382684f,  0.923880f),
                        new Mathematics.Vector3D(0.000000f,  0.555570f,  0.831470f),
                        new Mathematics.Vector3D(0.000000f,  0.707107f,  0.707107f),
                        new Mathematics.Vector3D(0.000000f,  0.831470f,  0.555570f),
                        new Mathematics.Vector3D(0.000000f,  0.923880f,  0.382683f),
                        new Mathematics.Vector3D(0.000000f,  0.980785f,  0.195090f),
                        new Mathematics.Vector3D(0.000000f,  1.000000f,  0.000000f),
                        new Mathematics.Vector3D(0.000000f,  0.980785f, -0.195090f),
                        new Mathematics.Vector3D(0.000000f,  0.923880f, -0.382683f),
                        new Mathematics.Vector3D(0.000000f,  0.831470f, -0.555570f),
                        ...
                        new Mathematics.Vector3D(0.000000f,  0.555570f, -0.831470f),
                        new Mathematics.Vector3D(0.000000f,  0.382684f, -0.923880f),
                        new Mathematics.Vector3D(0.000000f,  0.195090f, -0.980785f),
                        new Mathematics.Vector3D(0.038061f,  0.191342f,  0.980785f),
                        new Mathematics.Vector3D(0.074658f,  0.375330f,  0.923880f),
                        new Mathematics.Vector3D(0.108387f,  0.544895f,  0.831470f),
                        new Mathematics.Vector3D(0.137950f,  0.693520f,  0.707107f),
                        new Mathematics.Vector3D(0.162212f,  0.815493f,  0.555570f),
                        new Mathematics.Vector3D(0.180240f,  0.906128f,  0.382683f),
                        new Mathematics.Vector3D(0.191342f,  0.961940f,  0.195090f),
                        new Mathematics.Vector3D(0.195091f,  0.980785f,  0.000000f),
                        new Mathematics.Vector3D(0.191342f,  0.961940f, -0.195090f),
                        new Mathematics.Vector3D(0.180240f,  0.906128f, -0.382683f),
                        new Mathematics.Vector3D(0.162212f,  0.815493f, -0.555570f),
                        new Mathematics.Vector3D(0.137950f,  0.693520f, -0.707107f),
                        ...
                        new Mathematics.Vector3D(0.038061f,  0.191342f, -0.980785f),
                        new Mathematics.Vector3D(0.074658f,  0.180240f,  0.980785f),
                        new Mathematics.Vector3D(0.146447f,  0.353554f,  0.923880f),
                        new Mathematics.Vector3D(0.212608f,  0.513280f,  0.831470f),
                        new Mathematics.Vector3D(0.270598f,  0.653282f,  0.707107f),
                        new Mathematics.Vector3D(0.318190f,  0.768178f,  0.555570f),
                        new Mathematics.Vector3D(0.353554f,  0.853553f,  0.382683f),
                        new Mathematics.Vector3D(0.375331f,  0.906127f,  0.195090f),
                        new Mathematics.Vector3D(0.382684f,  0.923880f,  0.000000f),
                        new Mathematics.Vector3D(0.375331f,  0.906127f, -0.195090f),
                        new Mathematics.Vector3D(0.353554f,  0.853553f, -0.382683f),
                        new Mathematics.Vector3D(0.318190f,  0.768178f, -0.555570f),
                        new Mathematics.Vector3D(0.270598f,  0.653282f, -0.707107f),
                        new Mathematics.Vector3D(0.212608f,  0.513280f, -0.831470f),
                        new Mathematics.Vector3D(0.146447f,  0.353553f, -0.923880f),
                        new Mathematics.Vector3D(0.074658f,  0.180240f, -0.980785f),
                        new Mathematics.Vector3D(0.108387f,  0.162212f,  0.980785f),
                        new Mathematics.Vector3D(0.212608f,  0.318190f,  0.923880f),
                        new Mathematics.Vector3D(0.308659f,  0.461940f,  0.831470f),
                        new Mathematics.Vector3D(0.392848f,  0.587938f,  0.707107f),
                        new Mathematics.Vector3D(0.461940f,  0.691342f,  0.555570f),
                        new Mathematics.Vector3D(0.513280f,  0.768178f,  0.382683f),
                        new Mathematics.Vector3D(0.544895f,  0.815493f,  0.195090f),
                        new Mathematics.Vector3D(0.555571f,  0.831470f,  0.000000f),
                        new Mathematics.Vector3D(0.544895f,  0.815493f, -0.195090f),
                        new Mathematics.Vector3D(0.513280f,  0.768178f, -0.382683f),
                        new Mathematics.Vector3D(0.461940f,  0.691342f, -0.555570f),
                        new Mathematics.Vector3D(0.392848f,  0.587938f, -0.707107f),
                        ...
                        new Mathematics.Vector3D(0.108387f,  0.162212f, -0.980785f),
                        new Mathematics.Vector3D(0.137950f,  0.137950f,  0.980785f),
                        new Mathematics.Vector3D(0.270599f,  0.270598f,  0.923880f),
                        new Mathematics.Vector3D(0.392848f,  0.392847f,  0.831470f),
                        new Mathematics.Vector3D(0.500000f,  0.500000f,  0.707107f),
                        new Mathematics.Vector3D(0.587938f,  0.587938f,  0.555570f),
                        new Mathematics.Vector3D(0.653282f,  0.653281f,  0.382683f),
                        new Mathematics.Vector3D(0.693520f,  0.693520f,  0.195090f),
                        new Mathematics.Vector3D(0.707107f,  0.707107f,  0.000000f),
                        new Mathematics.Vector3D(0.693520f,  0.693520f, -0.195090f),
                        new Mathematics.Vector3D(0.653282f,  0.653281f, -0.382683f),
                        ...
                        new Mathematics.Vector3D(0.318190f,  0.212608f,  0.923880f),
                        new Mathematics.Vector3D(0.461940f,  0.308658f,  0.831470f),
                        new Mathematics.Vector3D(0.587938f,  0.392847f,  0.707107f),
                        new Mathematics.Vector3D(0.691342f,  0.461940f,  0.555570f),
                        new Mathematics.Vector3D(0.768178f,  0.513280f,  0.382683f),
                        new Mathematics.Vector3D(0.815493f,  0.544895f,  0.195090f),
                        new Mathematics.Vector3D(0.831470f,  0.555570f,  0.000000f),
                        ...
                        new Mathematics.Vector3D(0.461940f,  0.308658f, -0.831470f),
                        new Mathematics.Vector3D(0.318190f,  0.212608f, -0.923880f),
                        new Mathematics.Vector3D(0.162212f,  0.108386f, -0.980785f),
                        new Mathematics.Vector3D(0.180241f,  0.074658f,  0.980785f),
                        new Mathematics.Vector3D(0.353554f,  0.146447f,  0.923880f),
                        new Mathematics.Vector3D(0.513280f,  0.212607f,  0.831470f),
                        new Mathematics.Vector3D(0.653282f,  0.270598f,  0.707107f),
                        new Mathematics.Vector3D(0.768178f,  0.318190f,  0.555570f),
                        new Mathematics.Vector3D(0.853554f,  0.353553f,  0.382683f),
                        new Mathematics.Vector3D(0.906128f,  0.375330f,  0.195090f),
                        new Mathematics.Vector3D(0.923880f,  0.382683f,  0.000000f),
                        new Mathematics.Vector3D(0.906128f,  0.375330f, -0.195090f),
                        new Mathematics.Vector3D(0.853554f,  0.353553f, -0.382683f),
                        new Mathematics.Vector3D(0.768178f,  0.318190f, -0.555570f),
                        new Mathematics.Vector3D(0.653282f,  0.270598f, -0.707107f),
                        ...
                        new Mathematics.Vector3D(0.180240f,  0.074658f, -0.980785f),
                        new Mathematics.Vector3D(0.191342f,  0.038060f,  0.980785f),
                        new Mathematics.Vector3D(0.375331f,  0.074658f,  0.923880f),
                        new Mathematics.Vector3D(0.544895f,  0.108386f,  0.831470f),
                        new Mathematics.Vector3D(0.693520f,  0.137950f,  0.707107f),
                        new Mathematics.Vector3D(0.815493f,  0.162212f,  0.555570f),
                        new Mathematics.Vector3D(0.906128f,  0.180240f,  0.382683f),
                        new Mathematics.Vector3D(0.961940f,  0.191342f,  0.195090f),
                        new Mathematics.Vector3D(0.980785f,  0.195090f,  0.000000f),
                        new Mathematics.Vector3D(0.961940f,  0.191342f, -0.195090f),
                        new Mathematics.Vector3D(0.906128f,  0.180240f, -0.382683f),
                        ...
                        new Mathematics.Vector3D(0.375331f,  0.074658f, -0.923880f),
                        new Mathematics.Vector3D(0.191342f,  0.038060f, -0.980785f),
                        new Mathematics.Vector3D(0.195091f, -0.000000f,  0.980785f),
                        new Mathematics.Vector3D(0.382684f, -0.000000f,  0.923880f),
                        new Mathematics.Vector3D(0.555570f, -0.000000f,  0.831470f),
                        new Mathematics.Vector3D(0.707107f, -0.000000f,  0.707107f),
                        new Mathematics.Vector3D(0.831470f, -0.000000f,  0.555570f),
                        new Mathematics.Vector3D(0.923880f, -0.000000f,  0.382683f),
                        ...
                        new Mathematics.Vector3D(0.146447f, -0.353554f,  0.923880f),
                        new Mathematics.Vector3D(0.212608f, -0.513280f,  0.831470f),
                        new Mathematics.Vector3D(0.270598f, -0.653281f,  0.707107f),
                        new Mathematics.Vector3D(0.318190f, -0.768178f,  0.555570f),
                        new Mathematics.Vector3D(0.353553f, -0.853553f,  0.382683f),
                        new Mathematics.Vector3D(0.375330f, -0.906127f,  0.195090f),
                        new Mathematics.Vector3D(0.382683f, -0.923879f,  0.000000f),
                        new Mathematics.Vector3D(0.375330f, -0.906127f, -0.195090f),
                        new Mathematics.Vector3D(0.353554f, -0.853553f, -0.382683f),
                        new Mathematics.Vector3D(0.318190f, -0.768178f, -0.555570f),
                        new Mathematics.Vector3D(0.270598f, -0.653281f, -0.707107f),
                        ...
                        new Mathematics.Vector3D(0.137950f, -0.693520f,  0.707107f),
                        new Mathematics.Vector3D(0.162212f, -0.815493f,  0.555570f),
                        new Mathematics.Vector3D(0.180240f, -0.906127f,  0.382683f),
                        new Mathematics.Vector3D(0.191342f, -0.961939f,  0.195090f),
                        new Mathematics.Vector3D(0.195090f, -0.980785f,  0.000000f),
                        new Mathematics.Vector3D(0.191342f, -0.961939f, -0.195090f),
                        new Mathematics.Vector3D(0.180240f, -0.906127f, -0.382683f),
                        new Mathematics.Vector3D(0.162212f, -0.815493f, -0.555570f),
                        ...
                        new Mathematics.Vector3D(0.038061f, -0.191342f, -0.980785f),
                        new Mathematics.Vector3D(0.000000f, -0.195091f,  0.980785f),
                        new Mathematics.Vector3D(0.000000f, -0.382683f,  0.923880f),
                        new Mathematics.Vector3D(0.000000f, -0.555570f,  0.831470f),
                        new Mathematics.Vector3D(0.000000f, -0.707107f,  0.707107f),
                        new Mathematics.Vector3D(0.000000f, -0.831469f,  0.555570f),
                        new Mathematics.Vector3D(0.000000f, -0.923879f,  0.382683f),
                        new Mathematics.Vector3D(0.000000f, -0.980785f,  0.195090f),
                        new Mathematics.Vector3D(0.000000f, -1.000000f,  0.000000f),
                        new Mathematics.Vector3D(0.000000f, -0.980785f, -0.195090f),
                        new Mathematics.Vector3D(0.000000f, -0.923879f, -0.382683f),
                        ...
                        new Mathematics.Vector3D(-0.162211f, -0.815493f,  0.555570f),
                        new Mathematics.Vector3D(-0.180240f, -0.906127f,  0.382683f),
                        new Mathematics.Vector3D(-0.191341f, -0.961939f,  0.195090f),
                        new Mathematics.Vector3D(-0.195090f, -0.980785f,  0.000000f),
                        new Mathematics.Vector3D(-0.191342f, -0.961939f, -0.195090f),
                        new Mathematics.Vector3D(-0.180240f, -0.906127f, -0.382683f),
                        new Mathematics.Vector3D(-0.162211f, -0.815493f, -0.555570f),
                        ...
                        new Mathematics.Vector3D(-0.212607f, -0.513280f,  0.831470f),
                        new Mathematics.Vector3D(-0.270598f, -0.653281f,  0.707107f),
                        new Mathematics.Vector3D(-0.318189f, -0.768177f,  0.555570f),
                        new Mathematics.Vector3D(-0.353553f, -0.853553f,  0.382683f),
                        new Mathematics.Vector3D(-0.375330f, -0.906127f,  0.195090f),
                        new Mathematics.Vector3D(-0.382683f, -0.923879f,  0.000000f),
                        new Mathematics.Vector3D(-0.375330f, -0.906127f, -0.195090f),
                        ...
                        new Mathematics.Vector3D(-0.108386f, -0.162212f,  0.980785f),
                        new Mathematics.Vector3D(-0.212607f, -0.318190f,  0.923880f),
                        new Mathematics.Vector3D(-0.308658f, -0.461939f,  0.831470f),
                        new Mathematics.Vector3D(-0.392847f, -0.587937f,  0.707107f),
                        new Mathematics.Vector3D(-0.461939f, -0.691341f,  0.555570f),
                        new Mathematics.Vector3D(-0.513280f, -0.768177f,  0.382683f),
                        new Mathematics.Vector3D(-0.544895f, -0.815493f,  0.195090f),
                        new Mathematics.Vector3D(-0.555570f, -0.831469f,  0.000000f),
                        new Mathematics.Vector3D(-0.544895f, -0.815493f, -0.195090f),
                        new Mathematics.Vector3D(-0.513279f, -0.768177f, -0.382683f),
                        new Mathematics.Vector3D(-0.461939f, -0.691341f, -0.555570f),
                        new Mathematics.Vector3D(-0.392847f, -0.587937f, -0.707107f),
                        new Mathematics.Vector3D(-0.308658f, -0.461939f, -0.831470f),
                        new Mathematics.Vector3D(-0.212607f, -0.318189f, -0.923880f),
                        new Mathematics.Vector3D(-0.108386f, -0.162212f, -0.980785f),
                        new Mathematics.Vector3D(-0.137950f, -0.137950f,  0.980785f),
                        new Mathematics.Vector3D(-0.270598f, -0.270598f,  0.923880f),
                        new Mathematics.Vector3D(-0.392847f, -0.392847f,  0.831470f),
                        new Mathematics.Vector3D(-0.500000f, -0.500000f,  0.707107f),
                        new Mathematics.Vector3D(-0.587937f, -0.587937f,  0.555570f),
                        new Mathematics.Vector3D(-0.653281f, -0.653281f,  0.382683f),
                        new Mathematics.Vector3D(-0.693519f, -0.693519f,  0.195090f),
                        new Mathematics.Vector3D(-0.707106f, -0.707106f,  0.000000f),
                        new Mathematics.Vector3D(-0.693520f, -0.693519f, -0.195090f),
                        new Mathematics.Vector3D(-0.653281f, -0.653281f, -0.382683f),
                        new Mathematics.Vector3D(-0.587937f, -0.587937f, -0.555570f),
                        new Mathematics.Vector3D(-0.500000f, -0.500000f, -0.707107f),
                        new Mathematics.Vector3D(-0.392847f, -0.392847f, -0.831470f),
                        ...
                        new Mathematics.Vector3D(-0.137949f, -0.137950f, -0.980785f),
                        new Mathematics.Vector3D(-0.162212f, -0.108386f,  0.980785f),
                        new Mathematics.Vector3D(-0.318189f, -0.212607f,  0.923880f),
                        new Mathematics.Vector3D(-0.461939f, -0.308658f,  0.831470f),
                        new Mathematics.Vector3D(-0.587937f, -0.392847f,  0.707107f),
                        new Mathematics.Vector3D(-0.691341f, -0.461939f,  0.555570f),
                        new Mathematics.Vector3D(-0.768177f, -0.513279f,  0.382683f),
                        new Mathematics.Vector3D(-0.815492f, -0.544895f,  0.195090f),
                        new Mathematics.Vector3D(-0.831469f, -0.555570f,  0.000000f),
                        new Mathematics.Vector3D(-0.815493f, -0.544895f, -0.195090f),
                        new Mathematics.Vector3D(-0.768177f, -0.513280f, -0.382683f),
                        new Mathematics.Vector3D(-0.691341f, -0.461939f, -0.555570f),
                        new Mathematics.Vector3D(-0.587937f, -0.392847f, -0.707107f),
                        new Mathematics.Vector3D(-0.461939f, -0.308658f, -0.831470f),
                        new Mathematics.Vector3D(-0.318189f, -0.212607f, -0.923880f),
                        ...
                        new Mathematics.Vector3D(0.000000f, -0.000000f,  1.000000f),
                        new Mathematics.Vector3D(-0.180240f, -0.074658f,  0.980785f),
                        new Mathematics.Vector3D(-0.353553f, -0.146446f,  0.923880f),
                        new Mathematics.Vector3D(-0.513279f, -0.212607f,  0.831470f),
                        new Mathematics.Vector3D(-0.653281f, -0.270598f,  0.707107f),
                        new Mathematics.Vector3D(-0.768177f, -0.318189f,  0.555570f),
                        new Mathematics.Vector3D(-0.853553f, -0.353553f,  0.382683f),
                        new Mathematics.Vector3D(-0.906127f, -0.375330f,  0.195090f),
                        new Mathematics.Vector3D(-0.923879f, -0.382683f,  0.000000f),
                        new Mathematics.Vector3D(-0.906127f, -0.375330f, -0.195090f),
                        new Mathematics.Vector3D(-0.853553f, -0.353553f, -0.382683f),
                        new Mathematics.Vector3D(-0.768177f, -0.318189f, -0.555570f),
                        new Mathematics.Vector3D(-0.653281f, -0.270598f, -0.707107f),
                        ...
                        new Mathematics.Vector3D(-0.375330f, -0.074658f,  0.923880f),
                        new Mathematics.Vector3D(-0.544895f, -0.108386f,  0.831470f),
                        new Mathematics.Vector3D(-0.693519f, -0.137949f,  0.707107f),
                        new Mathematics.Vector3D(-0.815493f, -0.162211f,  0.555570f),
                        new Mathematics.Vector3D(-0.906127f, -0.180240f,  0.382683f),
                        new Mathematics.Vector3D(-0.961939f, -0.191341f,  0.195090f),
                        new Mathematics.Vector3D(-0.980784f, -0.195090f,  0.000000f),
                        new Mathematics.Vector3D(-0.961939f, -0.191341f, -0.195090f),
                        new Mathematics.Vector3D(-0.906127f, -0.180240f, -0.382683f),
                        new Mathematics.Vector3D(-0.815493f, -0.162211f, -0.555570f),
                        new Mathematics.Vector3D(-0.693519f, -0.137949f, -0.707107f),
                    ...
                    normals = new List<Mathematics.Vector3D>()
                    {
                        new Mathematics.Vector3D(-0.633159f,  0.062361f, -0.771506f),
                        new Mathematics.Vector3D(-0.990438f,  0.097550f,  0.097550f),
                        new Mathematics.Vector3D(-0.470890f,  0.046379f,  0.880972f),
                        new Mathematics.Vector3D(-0.470889f,  0.046379f, -0.880972f),
                        new Mathematics.Vector3D(-0.990438f,  0.097550f, -0.097550f),
                        new Mathematics.Vector3D(-0.633158f,  0.062361f,  0.771506f),
                        new Mathematics.Vector3D(-0.290166f,  0.028579f, -0.956550f),
                        new Mathematics.Vector3D(-0.952718f,  0.093835f, -0.289004f),
                        new Mathematics.Vector3D(-0.770780f,  0.075915f,  0.632563f),
                        new Mathematics.Vector3D(-0.878613f,  0.086536f, -0.469628f),
                        new Mathematics.Vector3D(-0.878613f,  0.086536f,  0.469628f),
                        new Mathematics.Vector3D(-0.770780f,  0.075915f, -0.632563f),
                        new Mathematics.Vector3D(-0.952718f,  0.093835f,  0.289004f),
                        new Mathematics.Vector3D(-0.290166f,  0.028579f,  0.956549f),
                        new Mathematics.Vector3D(-0.608827f,  0.184686f, -0.771506f),
                        new Mathematics.Vector3D(-0.952376f,  0.288900f,  0.097550f),
                        new Mathematics.Vector3D(-0.452794f,  0.137354f,  0.880972f),
                        new Mathematics.Vector3D(-0.452793f,  0.137354f, -0.880972f),
                        new Mathematics.Vector3D(-0.952376f,  0.288900f, -0.097550f),
                        new Mathematics.Vector3D(-0.608826f,  0.184686f,  0.771506f),
                        new Mathematics.Vector3D(-0.279015f,  0.084638f, -0.956550f),
                        new Mathematics.Vector3D(-0.916106f,  0.277898f, -0.289004f),
                        new Mathematics.Vector3D(-0.741159f,  0.224828f,  0.632562f),
                        new Mathematics.Vector3D(-0.844848f,  0.256282f, -0.469628f),
                        new Mathematics.Vector3D(-0.844848f,  0.256282f,  0.469628f),
                        new Mathematics.Vector3D(-0.741159f,  0.224828f, -0.632563f),
                        new Mathematics.Vector3D(-0.916106f,  0.277898f,  0.289004f),
                        new Mathematics.Vector3D(-0.279015f,  0.084638f,  0.956549f),
                        new Mathematics.Vector3D(-0.683056f,  0.365101f, -0.632563f),
                        new Mathematics.Vector3D(-0.844288f,  0.451281f,  0.289004f),
                        new Mathematics.Vector3D(-0.257142f,  0.137445f,  0.956549f),
                        new Mathematics.Vector3D(-0.561098f,  0.299913f, -0.771506f),
                        new Mathematics.Vector3D(-0.877715f,  0.469149f,  0.097550f),
                        new Mathematics.Vector3D(-0.417297f,  0.223050f,  0.880972f),
                        new Mathematics.Vector3D(-0.417297f,  0.223050f, -0.880972f),
                        new Mathematics.Vector3D(-0.877715f,  0.469149f, -0.097550f),
                        new Mathematics.Vector3D(-0.561097f,  0.299913f,  0.771506f),
                        new Mathematics.Vector3D(-0.257142f,  0.137445f, -0.956550f),
                        new Mathematics.Vector3D(-0.844288f,  0.451281f, -0.289004f),
                        new Mathematics.Vector3D(-0.683056f,  0.365101f,  0.632562f),
                        new Mathematics.Vector3D(-0.778617f,  0.416180f, -0.469628f),
                        new Mathematics.Vector3D(-0.778617f,  0.416179f,  0.469628f),
                        new Mathematics.Vector3D(-0.598704f,  0.491344f,  0.632562f),
                        new Mathematics.Vector3D(-0.682463f,  0.560083f, -0.469628f),
                        new Mathematics.Vector3D(-0.682463f,  0.560083f,  0.469628f),
                        new Mathematics.Vector3D(-0.598704f,  0.491343f, -0.632563f),
                        new Mathematics.Vector3D(-0.740025f,  0.607323f,  0.289004f),
                        new Mathematics.Vector3D(-0.225387f,  0.184970f,  0.956549f),
                        new Mathematics.Vector3D(-0.491806f,  0.403615f, -0.771506f),
                        new Mathematics.Vector3D(-0.769324f,  0.631368f,  0.097550f),
                        new Mathematics.Vector3D(-0.365764f,  0.300175f,  0.880972f),
                        new Mathematics.Vector3D(-0.365764f,  0.300175f, -0.880972f),
                        new Mathematics.Vector3D(-0.769324f,  0.631368f, -0.097550f),
                        new Mathematics.Vector3D(-0.491806f,  0.403615f,  0.771506f),
                        new Mathematics.Vector3D(-0.225386f,  0.184970f, -0.956550f),
                        new Mathematics.Vector3D(-0.740025f,  0.607323f, -0.289004f),
                        new Mathematics.Vector3D(-0.631367f,  0.769324f, -0.097550f),
                        new Mathematics.Vector3D(-0.403615f,  0.491806f,  0.771506f),
                        new Mathematics.Vector3D(-0.184970f,  0.225386f, -0.956550f),
                        new Mathematics.Vector3D(-0.607322f,  0.740025f, -0.289004f),
                        new Mathematics.Vector3D(-0.491343f,  0.598704f,  0.632562f),
                        new Mathematics.Vector3D(-0.560083f,  0.682463f, -0.469628f),
                        new Mathematics.Vector3D(-0.560083f,  0.682463f,  0.469628f),
                        new Mathematics.Vector3D(-0.491343f,  0.598704f, -0.632563f),
                        new Mathematics.Vector3D(-0.607322f,  0.740025f,  0.289004f),
                        new Mathematics.Vector3D(-0.184970f,  0.225387f,  0.956549f),
                        new Mathematics.Vector3D(-0.403615f,  0.491806f, -0.771506f),
                        new Mathematics.Vector3D(-0.631367f,  0.769324f,  0.097550f),
                        new Mathematics.Vector3D(-0.300175f,  0.365764f,  0.880972f),
                        new Mathematics.Vector3D(-0.300175f,  0.365764f, -0.880972f),
                        new Mathematics.Vector3D(-0.299913f,  0.561098f, -0.771506f),
                        new Mathematics.Vector3D(-0.469148f,  0.877715f,  0.097550f),
                        new Mathematics.Vector3D(-0.223050f,  0.417297f,  0.880972f),
                        new Mathematics.Vector3D(-0.223050f,  0.417297f, -0.880972f),
                        new Mathematics.Vector3D(-0.469148f,  0.877715f, -0.097550f),
                        new Mathematics.Vector3D(-0.299913f,  0.561098f,  0.771506f),
                        new Mathematics.Vector3D(-0.137445f,  0.257142f, -0.956550f),
                        new Mathematics.Vector3D(-0.451281f,  0.844288f, -0.289004f),
                        new Mathematics.Vector3D(-0.365101f,  0.683056f,  0.632562f),
                        new Mathematics.Vector3D(-0.416179f,  0.778617f, -0.469628f),
                        new Mathematics.Vector3D(-0.416179f,  0.778617f,  0.469628f),
                        new Mathematics.Vector3D(-0.365101f,  0.683056f, -0.632563f),
                        new Mathematics.Vector3D(-0.451281f,  0.844288f,  0.289004f),
                        new Mathematics.Vector3D(-0.137445f,  0.257142f,  0.956549f),
                        new Mathematics.Vector3D(-0.224828f,  0.741159f, -0.632563f),
                        new Mathematics.Vector3D(-0.277898f,  0.916106f,  0.289004f),
                        new Mathematics.Vector3D(-0.084638f,  0.279015f,  0.956549f),
                        new Mathematics.Vector3D(-0.184686f,  0.608827f, -0.771506f),
                        new Mathematics.Vector3D(-0.288900f,  0.952376f,  0.097550f),
                        new Mathematics.Vector3D(-0.137353f,  0.452794f,  0.880972f),
                        new Mathematics.Vector3D(-0.137353f,  0.452794f, -0.880972f),
                        new Mathematics.Vector3D(-0.288900f,  0.952376f, -0.097550f),
                        new Mathematics.Vector3D(-0.184685f,  0.608826f,  0.771506f),
                        new Mathematics.Vector3D(-0.084638f,  0.279015f, -0.956550f),
                        new Mathematics.Vector3D(-0.277898f,  0.916106f, -0.289004f),
                        new Mathematics.Vector3D(-0.224828f,  0.741159f,  0.632562f),
                        new Mathematics.Vector3D(-0.256282f,  0.844849f, -0.469628f),
                        new Mathematics.Vector3D(-0.256282f,  0.844848f,  0.469628f),
                        new Mathematics.Vector3D(-0.086536f,  0.878613f, -0.469628f),
                        new Mathematics.Vector3D(-0.086536f,  0.878613f,  0.469628f),
                        new Mathematics.Vector3D(-0.075915f,  0.770780f, -0.632563f),
                        new Mathematics.Vector3D(-0.093834f,  0.952718f,  0.289004f),
                        new Mathematics.Vector3D(-0.028579f,  0.290166f,  0.956549f),
                        new Mathematics.Vector3D(-0.062360f,  0.633159f, -0.771506f),
                        new Mathematics.Vector3D(-0.097549f,  0.990438f,  0.097550f),
                        new Mathematics.Vector3D(-0.046378f,  0.470890f,  0.880972f),
                        new Mathematics.Vector3D(-0.046378f,  0.470890f, -0.880972f),
                        new Mathematics.Vector3D(-0.097549f,  0.990438f, -0.097550f),
                        new Mathematics.Vector3D(-0.062360f,  0.633158f,  0.771506f),
                        new Mathematics.Vector3D(-0.028579f,  0.290166f, -0.956550f),
                        new Mathematics.Vector3D(-0.093834f,  0.952718f, -0.289004f),
                        new Mathematics.Vector3D(-0.075915f,  0.770780f,  0.632562f),
                        new Mathematics.Vector3D( 0.062361f,  0.633158f,  0.771506f),
                        new Mathematics.Vector3D( 0.028579f,  0.290166f, -0.956550f),
                        new Mathematics.Vector3D( 0.093835f,  0.952718f, -0.289004f),
                        new Mathematics.Vector3D( 0.075915f,  0.770780f,  0.632562f),
                        new Mathematics.Vector3D( 0.086536f,  0.878613f, -0.469628f),
                        new Mathematics.Vector3D( 0.086536f,  0.878613f,  0.469628f),
                        new Mathematics.Vector3D( 0.075915f,  0.770780f, -0.632563f),
                        new Mathematics.Vector3D( 0.093835f,  0.952718f,  0.289004f),
                        new Mathematics.Vector3D( 0.028579f,  0.290166f,  0.956549f),
                        new Mathematics.Vector3D( 0.062361f,  0.633159f, -0.771506f),
                        new Mathematics.Vector3D( 0.097550f,  0.990438f,  0.097550f),
                        new Mathematics.Vector3D( 0.046379f,  0.470890f,  0.880972f),
                        new Mathematics.Vector3D( 0.046379f,  0.470890f, -0.880972f),
                        new Mathematics.Vector3D( 0.097550f,  0.990438f, -0.097550f),
                        new Mathematics.Vector3D( 0.288900f,  0.952376f,  0.097550f),
                        new Mathematics.Vector3D( 0.137354f,  0.452794f,  0.880972f),
                        new Mathematics.Vector3D( 0.137354f,  0.452794f, -0.880972f),
                        new Mathematics.Vector3D( 0.288900f,  0.952376f, -0.097550f),
                        new Mathematics.Vector3D( 0.184686f,  0.608826f,  0.771506f),
                        new Mathematics.Vector3D( 0.084638f,  0.279015f, -0.956550f),
                        new Mathematics.Vector3D( 0.277898f,  0.916106f, -0.289004f),
                        new Mathematics.Vector3D( 0.224829f,  0.741159f,  0.632562f),
                        new Mathematics.Vector3D( 0.256282f,  0.844849f, -0.469628f),
                        new Mathematics.Vector3D( 0.256282f,  0.844848f,  0.469628f),
                        new Mathematics.Vector3D( 0.224828f,  0.741159f, -0.632563f),
                        new Mathematics.Vector3D( 0.277898f,  0.916106f,  0.289004f),
                        ...
                        new Mathematics.Vector3D( 0.184686f,  0.608827f, -0.771506f),
                        new Mathematics.Vector3D( 0.365101f,  0.683056f, -0.632563f),
                        new Mathematics.Vector3D( 0.451282f,  0.844288f,  0.289004f),
                        new Mathematics.Vector3D( 0.137445f,  0.257142f,  0.956549f),
                        new Mathematics.Vector3D( 0.299913f,  0.561098f, -0.771506f),
                        new Mathematics.Vector3D( 0.469149f,  0.877715f,  0.097550f),
                        new Mathematics.Vector3D( 0.223050f,  0.417297f,  0.880972f),
                        new Mathematics.Vector3D( 0.223050f,  0.417297f, -0.880972f),
                        new Mathematics.Vector3D( 0.469149f,  0.877715f, -0.097550f),
                        new Mathematics.Vector3D( 0.299913f,  0.561098f,  0.771506f),
                        ...
                        new Mathematics.Vector3D( 0.451282f,  0.844288f, -0.289004f),
                        new Mathematics.Vector3D( 0.365101f,  0.683056f,  0.632562f),
                        new Mathematics.Vector3D( 0.416180f,  0.778617f, -0.469628f),
                        new Mathematics.Vector3D( 0.416180f,  0.778617f,  0.469628f),
                        new Mathematics.Vector3D( 0.560084f,  0.682463f, -0.469628f),
                        new Mathematics.Vector3D( 0.560083f,  0.682463f,  0.469628f),
                        new Mathematics.Vector3D( 0.491344f,  0.598704f, -0.632563f),
                        new Mathematics.Vector3D( 0.607323f,  0.740024f,  0.289003f),
                        new Mathematics.Vector3D( 0.184970f,  0.225387f,  0.956549f),
                        new Mathematics.Vector3D( 0.403615f,  0.491807f, -0.771506f),
                        new Mathematics.Vector3D( 0.631368f,  0.769323f,  0.097550f),
                        new Mathematics.Vector3D( 0.300175f,  0.365764f,  0.880972f),
                        new Mathematics.Vector3D( 0.300175f,  0.365764f, -0.880972f),
                        new Mathematics.Vector3D( 0.631368f,  0.769323f, -0.097550f),
                        new Mathematics.Vector3D( 0.403615f,  0.491806f,  0.771506f),
                        new Mathematics.Vector3D( 0.184970f,  0.225386f, -0.956549f),
                        new Mathematics.Vector3D( 0.607323f,  0.740024f, -0.289004f),
                        new Mathematics.Vector3D( 0.491344f,  0.598704f,  0.632562f),
                        new Mathematics.Vector3D( 0.491806f,  0.403615f,  0.771506f),
                        new Mathematics.Vector3D( 0.225387f,  0.184970f, -0.956550f),
                        new Mathematics.Vector3D( 0.740025f,  0.607322f, -0.289004f),
                        new Mathematics.Vector3D( 0.598704f,  0.491343f,  0.632562f),
                        new Mathematics.Vector3D( 0.682464f,  0.560083f, -0.469628f),
                        new Mathematics.Vector3D( 0.682463f,  0.560083f,  0.469629f),
                        new Mathematics.Vector3D( 0.598704f,  0.491343f, -0.632563f),
                        new Mathematics.Vector3D( 0.740025f,  0.607322f,  0.289003f),
                        new Mathematics.Vector3D( 0.225387f,  0.184970f,  0.956549f),
                        new Mathematics.Vector3D( 0.491807f,  0.403615f, -0.771506f),
                        new Mathematics.Vector3D( 0.769324f,  0.631367f,  0.097550f),
                        new Mathematics.Vector3D( 0.365764f,  0.300175f,  0.880972f),
                        new Mathematics.Vector3D( 0.365764f,  0.300175f, -0.880972f),
                        new Mathematics.Vector3D( 0.769324f,  0.631368f, -0.097550f),
                        new Mathematics.Vector3D( 0.877715f,  0.469148f,  0.097550f),
                        new Mathematics.Vector3D( 0.417297f,  0.223050f,  0.880972f),
                        new Mathematics.Vector3D( 0.417297f,  0.223050f, -0.880972f),
                        new Mathematics.Vector3D( 0.877715f,  0.469148f, -0.097550f),
                        new Mathematics.Vector3D( 0.561098f,  0.299913f,  0.771506f),
                        new Mathematics.Vector3D( 0.257142f,  0.137445f, -0.956550f),
                        new Mathematics.Vector3D( 0.844288f,  0.451281f, -0.289004f),
                        new Mathematics.Vector3D( 0.683057f,  0.365101f,  0.632562f),
                        new Mathematics.Vector3D( 0.778617f,  0.416179f, -0.469628f),
                        new Mathematics.Vector3D( 0.778617f,  0.416179f,  0.469629f),
                        new Mathematics.Vector3D( 0.683056f,  0.365101f, -0.632563f),
                        new Mathematics.Vector3D( 0.844288f,  0.451281f,  0.289003f),
                        new Mathematics.Vector3D( 0.257142f,  0.137445f,  0.956549f),
                        new Mathematics.Vector3D( 0.561098f,  0.299913f, -0.771506f),
                        new Mathematics.Vector3D( 0.741159f,  0.224828f, -0.632563f),
                        new Mathematics.Vector3D( 0.916106f,  0.277897f,  0.289003f),
                        new Mathematics.Vector3D( 0.279015f,  0.084638f,  0.956549f),
                        new Mathematics.Vector3D( 0.608827f,  0.184685f, -0.771506f),
                        new Mathematics.Vector3D( 0.952376f,  0.288900f,  0.097550f),
                        new Mathematics.Vector3D( 0.452794f,  0.137353f,  0.880972f),
                        new Mathematics.Vector3D( 0.452794f,  0.137353f, -0.880972f),
                        new Mathematics.Vector3D( 0.952376f,  0.288900f, -0.097550f),
                        new Mathematics.Vector3D( 0.608827f,  0.184685f,  0.771506f),
                        new Mathematics.Vector3D( 0.279015f,  0.084638f, -0.956550f),
                        new Mathematics.Vector3D( 0.916106f,  0.277898f, -0.289004f),
                        new Mathematics.Vector3D( 0.741159f,  0.224828f,  0.632562f),
                        new Mathematics.Vector3D( 0.844849f,  0.256282f, -0.469628f),
                        new Mathematics.Vector3D( 0.844848f,  0.256282f,  0.469629f),
                        new Mathematics.Vector3D( 0.878613f,  0.086536f, -0.469628f),
                        new Mathematics.Vector3D( 0.878613f,  0.086536f,  0.469629f),
                        new Mathematics.Vector3D( 0.770780f,  0.075915f, -0.632563f),
                        new Mathematics.Vector3D( 0.952718f,  0.093834f,  0.289003f),
                        new Mathematics.Vector3D( 0.290166f,  0.028579f,  0.956549f),
                        new Mathematics.Vector3D( 0.633159f,  0.062360f, -0.771506f),
                        new Mathematics.Vector3D( 0.990438f,  0.097550f,  0.097551f),
                        new Mathematics.Vector3D( 0.470890f,  0.046378f,  0.880972f),
                        new Mathematics.Vector3D( 0.470890f,  0.046378f, -0.880972f),
                        new Mathematics.Vector3D( 0.990438f,  0.097550f, -0.097550f),
                        new Mathematics.Vector3D( 0.633158f,  0.062360f,  0.771506f),
                        new Mathematics.Vector3D( 0.290166f,  0.028579f, -0.956550f),
                        new Mathematics.Vector3D( 0.952718f,  0.093834f, -0.289004f),
                        new Mathematics.Vector3D( 0.770780f,  0.075915f,  0.632562f),
                        new Mathematics.Vector3D( 0.290166f, -0.028579f, -0.956550f),
                        new Mathematics.Vector3D( 0.952718f, -0.093835f, -0.289004f),
                        new Mathematics.Vector3D( 0.770780f, -0.075915f,  0.632562f),
                        new Mathematics.Vector3D( 0.878613f, -0.086536f, -0.469628f),
                        new Mathematics.Vector3D( 0.878613f, -0.086536f,  0.469628f),
                        new Mathematics.Vector3D( 0.770780f, -0.075915f, -0.632563f),
                        new Mathematics.Vector3D( 0.952718f, -0.093835f,  0.289003f),
                        new Mathematics.Vector3D( 0.290166f, -0.028579f,  0.956549f),
                        new Mathematics.Vector3D( 0.633159f, -0.062361f, -0.771506f),
                        new Mathematics.Vector3D( 0.990438f, -0.097550f,  0.097551f),
                        new Mathematics.Vector3D( 0.470890f, -0.046379f,  0.880972f),
                        ...
                        new Mathematics.Vector3D( 0.844848f, -0.256282f,  0.469628f),
                        new Mathematics.Vector3D( 0.741159f, -0.224828f, -0.632563f),
                        new Mathematics.Vector3D( 0.916106f, -0.277898f,  0.289003f),
                        new Mathematics.Vector3D( 0.279015f, -0.084638f,  0.956549f),
                        new Mathematics.Vector3D( 0.608827f, -0.184686f, -0.771506f),
                        new Mathematics.Vector3D( 0.952376f, -0.288900f,  0.097551f),
                        new Mathematics.Vector3D( 0.844288f, -0.451281f,  0.289003f),
                        new Mathematics.Vector3D( 0.257142f, -0.137445f,  0.956549f),
                        new Mathematics.Vector3D( 0.561098f, -0.299913f, -0.771506f),
                        new Mathematics.Vector3D( 0.877715f, -0.469149f,  0.097551f),
                        new Mathematics.Vector3D( 0.417297f, -0.223050f,  0.880972f),
                        new Mathematics.Vector3D( 0.417297f, -0.223050f, -0.880972f),
                        new Mathematics.Vector3D( 0.877715f, -0.469149f, -0.097550f),
                        new Mathematics.Vector3D( 0.561098f, -0.299913f,  0.771506f),
                        new Mathematics.Vector3D( 0.257142f, -0.137445f, -0.956549f),
                        new Mathematics.Vector3D( 0.844288f, -0.451282f, -0.289004f),
                        new Mathematics.Vector3D( 0.683056f, -0.365101f,  0.632562f),
                        new Mathematics.Vector3D( 0.778617f, -0.416180f, -0.469628f),
                        new Mathematics.Vector3D( 0.778616f, -0.416180f,  0.469628f),
                        new Mathematics.Vector3D( 0.683056f, -0.365101f, -0.632563f),
                        new Mathematics.Vector3D( 0.682463f, -0.560084f, -0.469628f),
                        new Mathematics.Vector3D( 0.682463f, -0.560083f,  0.469628f),
                        new Mathematics.Vector3D( 0.598704f, -0.491344f, -0.632563f),
                        new Mathematics.Vector3D( 0.740025f, -0.607323f,  0.289003f),
                        new Mathematics.Vector3D( 0.225387f, -0.184970f,  0.956549f),
                        new Mathematics.Vector3D( 0.491806f, -0.403615f, -0.771506f),
                        new Mathematics.Vector3D( 0.769323f, -0.631368f,  0.097551f),
                        new Mathematics.Vector3D( 0.365764f, -0.300175f,  0.880972f),
                        new Mathematics.Vector3D( 0.365764f, -0.300175f, -0.880972f),
                        new Mathematics.Vector3D( 0.769323f, -0.631368f, -0.097550f),
                        new Mathematics.Vector3D( 0.491806f, -0.403615f,  0.771506f),
                        new Mathematics.Vector3D( 0.225387f, -0.184970f, -0.956550f),
                        new Mathematics.Vector3D( 0.740024f, -0.607323f, -0.289004f),
                        new Mathematics.Vector3D( 0.598704f, -0.491344f,  0.632562f),
                        new Mathematics.Vector3D( 0.184970f, -0.225387f, -0.956550f),
                        new Mathematics.Vector3D( 0.607322f, -0.740025f, -0.289004f),
                        new Mathematics.Vector3D( 0.491344f, -0.598704f,  0.632562f),
                        new Mathematics.Vector3D( 0.560083f, -0.682464f, -0.469628f),
                        new Mathematics.Vector3D( 0.560083f, -0.682463f,  0.469629f),
                        new Mathematics.Vector3D( 0.491343f, -0.598704f, -0.632563f),
                        new Mathematics.Vector3D( 0.607322f, -0.740025f,  0.289003f),
                        new Mathematics.Vector3D( 0.184970f, -0.225387f,  0.956549f),
                        new Mathematics.Vector3D( 0.403615f, -0.491807f, -0.771506f),
                        new Mathematics.Vector3D( 0.631367f, -0.769324f,  0.097550f),
                        new Mathematics.Vector3D( 0.300175f, -0.365764f,  0.880972f),
                        ...
                        new Mathematics.Vector3D( 0.631367f, -0.769324f, -0.097550f),
                        new Mathematics.Vector3D( 0.403615f, -0.491806f,  0.771506f),
                        new Mathematics.Vector3D( 0.223050f, -0.417298f,  0.880972f),
                        new Mathematics.Vector3D( 0.223050f, -0.417297f, -0.880972f),
                        new Mathematics.Vector3D( 0.469148f, -0.877715f, -0.097550f),
                        new Mathematics.Vector3D( 0.299913f, -0.561098f,  0.771506f),
                        new Mathematics.Vector3D( 0.137445f, -0.257142f, -0.956550f),
                        new Mathematics.Vector3D( 0.451281f, -0.844288f, -0.289004f),
                        new Mathematics.Vector3D( 0.365101f, -0.683057f,  0.632562f),
                        new Mathematics.Vector3D( 0.416179f, -0.778617f, -0.469628f),
                        new Mathematics.Vector3D( 0.416179f, -0.778617f,  0.469628f),
                        new Mathematics.Vector3D( 0.365101f, -0.683056f, -0.632563f),
                        new Mathematics.Vector3D( 0.451281f, -0.844288f,  0.289003f),
                        new Mathematics.Vector3D( 0.137445f, -0.257142f,  0.956549f),
                        new Mathematics.Vector3D( 0.299913f, -0.561098f, -0.771506f),
                        new Mathematics.Vector3D( 0.469148f, -0.877715f,  0.097550f),
                        new Mathematics.Vector3D( 0.277897f, -0.916106f,  0.289003f),
                        new Mathematics.Vector3D( 0.084638f, -0.279015f,  0.956549f),
                        new Mathematics.Vector3D( 0.184685f, -0.608827f, -0.771506f),
                        new Mathematics.Vector3D( 0.288900f, -0.952376f,  0.097550f),
                        new Mathematics.Vector3D( 0.137353f, -0.452794f,  0.880972f),
                        new Mathematics.Vector3D( 0.137353f, -0.452794f, -0.880972f),
                        new Mathematics.Vector3D( 0.288900f, -0.952376f, -0.097550f),
                        new Mathematics.Vector3D( 0.184685f, -0.608826f,  0.771506f),
                        new Mathematics.Vector3D( 0.084638f, -0.279015f, -0.956549f),
                        new Mathematics.Vector3D( 0.277897f, -0.916106f, -0.289004f),
                        new Mathematics.Vector3D( 0.224828f, -0.741159f,  0.632562f),
                        new Mathematics.Vector3D( 0.256282f, -0.844849f, -0.469627f),
                        new Mathematics.Vector3D( 0.256282f, -0.844848f,  0.469628f),
                        new Mathematics.Vector3D( 0.224828f, -0.741159f, -0.632563f),
                        new Mathematics.Vector3D( 0.086536f, -0.878613f, -0.469627f),
                        new Mathematics.Vector3D( 0.086535f, -0.878613f,  0.469628f),
                        new Mathematics.Vector3D( 0.075915f, -0.770780f, -0.632563f),
                        new Mathematics.Vector3D( 0.093834f, -0.952718f,  0.289003f),
                        new Mathematics.Vector3D( 0.028579f, -0.290166f,  0.956549f),
                        new Mathematics.Vector3D( 0.062360f, -0.633159f, -0.771506f),
                        new Mathematics.Vector3D( 0.097549f, -0.990438f,  0.097550f),
                        new Mathematics.Vector3D( 0.046378f, -0.470890f,  0.880972f),
                        ...
                        new Mathematics.Vector3D(-0.086536f, -0.878613f,  0.469628f),
                        new Mathematics.Vector3D(-0.075915f, -0.770780f, -0.632562f),
                        new Mathematics.Vector3D(-0.093835f, -0.952718f,  0.289003f),
                        new Mathematics.Vector3D(-0.028579f, -0.290166f,  0.956549f),
                        new Mathematics.Vector3D(-0.062361f, -0.633159f, -0.771506f),
                        new Mathematics.Vector3D(-0.097550f, -0.990438f,  0.097550f),
                        new Mathematics.Vector3D(-0.046379f, -0.470890f,  0.880972f),
                        ...
                        new Mathematics.Vector3D(-0.062361f, -0.633158f,  0.771506f),
                        new Mathematics.Vector3D(-0.137354f, -0.452794f, -0.880972f),
                        new Mathematics.Vector3D(-0.288901f, -0.952376f, -0.097550f),
                        new Mathematics.Vector3D(-0.184686f, -0.608826f,  0.771506f),
                        new Mathematics.Vector3D(-0.084638f, -0.279015f, -0.956550f),
                        new Mathematics.Vector3D(-0.277898f, -0.916106f, -0.289004f),
                        new Mathematics.Vector3D(-0.224829f, -0.741159f,  0.632562f),
                        ...
                        new Mathematics.Vector3D(-0.256282f, -0.844848f,  0.469628f),
                        new Mathematics.Vector3D(-0.224828f, -0.741159f, -0.632563f),
                        new Mathematics.Vector3D(-0.277898f, -0.916106f,  0.289003f),
                        new Mathematics.Vector3D(-0.084638f, -0.279015f,  0.956549f),
                        new Mathematics.Vector3D(-0.184686f, -0.608827f, -0.771506f),
                        new Mathematics.Vector3D(-0.288901f, -0.952376f,  0.097550f),
                        new Mathematics.Vector3D(-0.137354f, -0.452794f,  0.880972f),
                        ...
                        new Mathematics.Vector3D(-0.223050f, -0.417297f, -0.880972f),
                        new Mathematics.Vector3D(-0.469149f, -0.877715f, -0.097550f),
                        new Mathematics.Vector3D(-0.299913f, -0.561097f,  0.771506f),
                        new Mathematics.Vector3D(-0.137445f, -0.257142f, -0.956549f),
                        new Mathematics.Vector3D(-0.451281f, -0.844288f, -0.289004f),
                        new Mathematics.Vector3D(-0.365101f, -0.683056f,  0.632562f),
                        new Mathematics.Vector3D(-0.416180f, -0.778617f, -0.469627f),
                        new Mathematics.Vector3D(-0.416180f, -0.778617f,  0.469628f),
                        new Mathematics.Vector3D(-0.365101f, -0.683056f, -0.632563f),
                        new Mathematics.Vector3D(-0.451281f, -0.844288f,  0.289003f),
                        new Mathematics.Vector3D(-0.560084f, -0.682463f,  0.469628f),
                        ...
                        new Mathematics.Vector3D(-0.607323f, -0.740024f, -0.289004f),
                        new Mathematics.Vector3D(-0.491344f, -0.598704f,  0.632562f),
                        new Mathematics.Vector3D(-0.560084f, -0.682464f, -0.469627f),
                        new Mathematics.Vector3D(-0.740025f, -0.607322f, -0.289004f),
                        new Mathematics.Vector3D(-0.598704f, -0.491343f,  0.632562f),
                        new Mathematics.Vector3D(-0.682464f, -0.560083f, -0.469627f),
                        new Mathematics.Vector3D(-0.682464f, -0.560083f,  0.469628f),
                        new Mathematics.Vector3D(-0.598704f, -0.491343f, -0.632563f),
                        new Mathematics.Vector3D(-0.740025f, -0.607322f,  0.289003f),
                        new Mathematics.Vector3D(-0.225387f, -0.184970f,  0.956549f),
                        new Mathematics.Vector3D(-0.491807f, -0.403615f, -0.771506f),
                        new Mathematics.Vector3D(-0.769324f, -0.631367f,  0.097550f),
                        new Mathematics.Vector3D(-0.365765f, -0.300175f,  0.880972f),
                        new Mathematics.Vector3D(-0.365764f, -0.300175f, -0.880972f),
                        new Mathematics.Vector3D(-0.769324f, -0.631367f, -0.097550f),
                        new Mathematics.Vector3D(-0.491806f, -0.403615f,  0.771506f),
                        new Mathematics.Vector3D(-0.225387f, -0.184970f, -0.956550f),
                        ...
                        new Mathematics.Vector3D(-0.844288f, -0.451281f, -0.289004f),
                        new Mathematics.Vector3D(-0.683057f, -0.365101f,  0.632562f),
                        new Mathematics.Vector3D(-0.778617f, -0.416179f, -0.469627f),
                        new Mathematics.Vector3D(-0.778617f, -0.416179f,  0.469628f),
                        new Mathematics.Vector3D(-0.683056f, -0.365101f, -0.632563f),
                        new Mathematics.Vector3D(-0.844288f, -0.451281f,  0.289003f),
                        new Mathematics.Vector3D(-0.257142f, -0.137445f,  0.956549f),
                        new Mathematics.Vector3D(-0.561098f, -0.299913f, -0.771506f),
                        new Mathematics.Vector3D(-0.877715f, -0.469148f,  0.097550f),
                        new Mathematics.Vector3D(-0.417298f, -0.223050f,  0.880972f),
                        new Mathematics.Vector3D(-0.279015f, -0.084638f,  0.956549f),
                        new Mathematics.Vector3D(-0.608827f, -0.184685f, -0.771506f),
                        new Mathematics.Vector3D(-0.952376f, -0.288900f,  0.097550f),
                        new Mathematics.Vector3D(-0.452794f, -0.137353f,  0.880972f),
                        new Mathematics.Vector3D(-0.452794f, -0.137353f, -0.880972f),
                        new Mathematics.Vector3D(-0.952376f, -0.288900f, -0.097550f),
                        new Mathematics.Vector3D(-0.608826f, -0.184685f,  0.771506f),
                        new Mathematics.Vector3D(-0.279015f, -0.084638f, -0.956549f),
                        new Mathematics.Vector3D(-0.916106f, -0.277897f, -0.289004f),
                        new Mathematics.Vector3D(-0.741159f, -0.224828f,  0.632562f),
                        new Mathematics.Vector3D(-0.844849f, -0.256282f, -0.469627f),
                        new Mathematics.Vector3D(-0.844849f, -0.256282f,  0.469628f),
                        new Mathematics.Vector3D(-0.741159f, -0.224828f, -0.632563f),
                        new Mathematics.Vector3D(-0.916106f, -0.277897f,  0.289003f),
                        new Mathematics.Vector3D(-0.098012f,  0.009653f, -0.995138f),
                        new Mathematics.Vector3D(-0.098013f,  0.009653f,  0.995138f),
                        new Mathematics.Vector3D(-0.094246f,  0.028589f, -0.995138f),
                        new Mathematics.Vector3D(-0.094246f,  0.028589f,  0.995138f),
                        new Mathematics.Vector3D(-0.086858f,  0.046426f,  0.995138f),
                        new Mathematics.Vector3D(-0.086857f,  0.046426f, -0.995138f),
                        new Mathematics.Vector3D(-0.076131f,  0.062479f, -0.995138f),
                        new Mathematics.Vector3D(-0.076131f,  0.062479f,  0.995138f),
                        new Mathematics.Vector3D(-0.062479f,  0.076131f, -0.995138f),
                        new Mathematics.Vector3D(-0.062479f,  0.076131f,  0.995138f),
                        new Mathematics.Vector3D(-0.046426f,  0.086857f, -0.995138f),
                        new Mathematics.Vector3D(-0.046426f,  0.086858f,  0.995138f),
                        new Mathematics.Vector3D(-0.028589f,  0.094246f, -0.995138f),
                        new Mathematics.Vector3D(-0.028589f,  0.094246f,  0.995138f),
                        new Mathematics.Vector3D(-0.009653f,  0.098012f, -0.995138f),
                        new Mathematics.Vector3D(-0.009653f,  0.098013f,  0.995138f),
                        new Mathematics.Vector3D( 0.009653f,  0.098012f, -0.995138f),
                        new Mathematics.Vector3D( 0.009653f,  0.098012f,  0.995138f),
                        new Mathematics.Vector3D( 0.028589f,  0.094246f, -0.995138f),
                        new Mathematics.Vector3D( 0.028589f,  0.094246f,  0.995138f),
                        ...
                        new Mathematics.Vector3D(-0.046426f, -0.086857f, -0.995138f),
                        new Mathematics.Vector3D(-0.046426f, -0.086858f,  0.995138f),
                        new Mathematics.Vector3D(-0.062480f, -0.076131f,  0.995138f),
                        new Mathematics.Vector3D(-0.062479f, -0.076131f, -0.995138f),
                        new Mathematics.Vector3D(-0.076131f, -0.062479f, -0.995138f),
                        new Mathematics.Vector3D(-0.076132f, -0.062479f,  0.995138f),
                        new Mathematics.Vector3D(-0.086858f, -0.046426f, -0.995138f),
                        new Mathematics.Vector3D(-0.086858f, -0.046426f,  0.995138f),
                        new Mathematics.Vector3D(-0.094246f, -0.028589f, -0.995138f),
                        new Mathematics.Vector3D(-0.094246f, -0.028589f,  0.995138f),
                        new Mathematics.Vector3D(-0.878613f, -0.086540f,  0.469628f),
                        new Mathematics.Vector3D(-0.098013f, -0.009654f,  0.995138f),
                        new Mathematics.Vector3D(-0.770779f, -0.075919f, -0.632563f),
                        new Mathematics.Vector3D(-0.952718f, -0.093839f,  0.289003f),
                        new Mathematics.Vector3D(-0.290166f, -0.028580f,  0.956549f),
                        new Mathematics.Vector3D(-0.633158f, -0.062364f, -0.771506f),
                        new Mathematics.Vector3D(-0.990438f, -0.097554f,  0.097550f),
                        new Mathematics.Vector3D(-0.470890f, -0.046381f,  0.880972f),
                        new Mathematics.Vector3D(-0.470889f, -0.046381f, -0.880972f),
                        new Mathematics.Vector3D(-0.990438f, -0.097554f, -0.097550f),
                        new Mathematics.Vector3D(-0.633158f, -0.062364f,  0.771506f),
                        new Mathematics.Vector3D(-0.290166f, -0.028580f, -0.956550f),
                        new Mathematics.Vector3D(-0.952718f, -0.093839f, -0.289004f),
                        new Mathematics.Vector3D(-0.770780f, -0.075919f,  0.632562f),
                        new Mathematics.Vector3D(-0.098012f, -0.009654f, -0.995138f),
                        new Mathematics.Vector3D(-0.878613f, -0.086540f, -0.469628f)
                    },
                    normalGroups = new List<int[]>()
                    {
            ...
            private void CreateTorus()
            {
                Polygon primitive = new Polygon()
                {
                    vertices = new List<Mathematics.Vector3D>()
                    {
                        new Mathematics.Vector3D(1.250000f,  0.000000f,  0.000000f),
                        new Mathematics.Vector3D(1.216506f,  0.000000f,  0.125000f),
                        new Mathematics.Vector3D(1.125000f,  0.000000f,  0.216506f),
                        new Mathematics.Vector3D(1.000000f,  0.000000f,  0.250000f),
                        new Mathematics.Vector3D(0.875000f,  0.000000f,  0.216506f),
                        new Mathematics.Vector3D(0.783494f,  0.000000f,  0.125000f),
                        new Mathematics.Vector3D(0.750000f,  0.000000f,  0.000000f),
                        new Mathematics.Vector3D(0.783494f,  0.000000f, -0.125000f),
                        new Mathematics.Vector3D(0.875000f,  0.000000f, -0.216506f),
                        new Mathematics.Vector3D(1.000000f,  0.000000f, -0.250000f),
                        new Mathematics.Vector3D(1.125000f,  0.000000f, -0.216506f),
                        new Mathematics.Vector3D(1.216506f,  0.000000f, -0.125000f),
                        new Mathematics.Vector3D(1.239306f,  0.163158f,  0.000000f),
                        new Mathematics.Vector3D(1.206099f,  0.158786f,  0.125000f),
                        new Mathematics.Vector3D(1.115376f,  0.146842f,  0.216506f),
                        new Mathematics.Vector3D(0.991445f,  0.130526f,  0.250000f),
                        new Mathematics.Vector3D(0.867514f,  0.114210f,  0.216506f),
                        new Mathematics.Vector3D(0.776791f,  0.102266f,  0.125000f),
                        new Mathematics.Vector3D(0.743584f,  0.097895f,  0.000000f),
                        new Mathematics.Vector3D(0.776791f,  0.102266f, -0.125000f),
                        new Mathematics.Vector3D(0.867514f,  0.114210f, -0.216506f),
                        new Mathematics.Vector3D(0.991445f,  0.130526f, -0.250000f),
                        new Mathematics.Vector3D(1.115376f,  0.146842f, -0.216506f),
                        new Mathematics.Vector3D(1.206099f,  0.158786f, -0.125000f),
                        new Mathematics.Vector3D(1.207407f,  0.323524f,  0.000000f),
                        new Mathematics.Vector3D(1.175055f,  0.314855f,  0.125000f),
                        new Mathematics.Vector3D(1.086667f,  0.291171f,  0.216506f),
                        new Mathematics.Vector3D(0.965926f,  0.258819f,  0.250000f),
                        new Mathematics.Vector3D(0.845185f,  0.226467f,  0.216506f),
                        new Mathematics.Vector3D(0.756797f,  0.202783f,  0.125000f),
                        new Mathematics.Vector3D(0.724444f,  0.194114f,  0.000000f),
                        new Mathematics.Vector3D(0.756797f,  0.202783f, -0.125000f),
                        new Mathematics.Vector3D(0.845185f,  0.226467f, -0.216506f),
                        new Mathematics.Vector3D(0.965926f,  0.258819f, -0.250000f),
                        new Mathematics.Vector3D(1.086667f,  0.291171f, -0.216506f),
                        new Mathematics.Vector3D(1.175055f,  0.314855f, -0.125000f),
                        new Mathematics.Vector3D(1.154849f,  0.478354f,  0.000000f),
                        new Mathematics.Vector3D(1.123905f,  0.465537f,  0.125000f),
                        new Mathematics.Vector3D(1.039364f,  0.430519f,  0.216506f),
                        new Mathematics.Vector3D(0.923880f,  0.382683f,  0.250000f),
                        new Mathematics.Vector3D(0.808395f,  0.334848f,  0.216506f),
                        new Mathematics.Vector3D(0.723854f,  0.299830f,  0.125000f),
                        new Mathematics.Vector3D(0.692910f,  0.287013f,  0.000000f),
                        new Mathematics.Vector3D(0.723854f,  0.299830f, -0.125000f),
                        new Mathematics.Vector3D(0.808395f,  0.334848f, -0.216506f),
                        new Mathematics.Vector3D(0.923880f,  0.382683f, -0.250000f),
                        new Mathematics.Vector3D(1.039364f,  0.430519f, -0.216506f),
                        new Mathematics.Vector3D(1.123905f,  0.465537f, -0.125000f),
                        new Mathematics.Vector3D(1.082532f,  0.625000f,  0.000000f),
                        new Mathematics.Vector3D(1.053525f,  0.608253f,  0.125000f),
                        new Mathematics.Vector3D(0.974279f,  0.562500f,  0.216506f),
                        new Mathematics.Vector3D(0.866025f,  0.500000f,  0.250000f),
                        new Mathematics.Vector3D(0.757772f,  0.437500f,  0.216506f),
                        new Mathematics.Vector3D(0.678525f,  0.391747f,  0.125000f),
                        new Mathematics.Vector3D(0.649519f,  0.375000f,  0.000000f),
                        new Mathematics.Vector3D(0.678525f,  0.391747f, -0.125000f),
                        new Mathematics.Vector3D(0.757772f,  0.437500f, -0.216506f),
                        new Mathematics.Vector3D(0.866025f,  0.500000f, -0.250000f),
                        new Mathematics.Vector3D(0.974279f,  0.562500f, -0.216506f),
                        new Mathematics.Vector3D(1.053525f,  0.608253f, -0.125000f),
                        new Mathematics.Vector3D(0.991692f,  0.760952f,  0.000000f),
                        new Mathematics.Vector3D(0.965119f,  0.740562f,  0.125000f),
                        new Mathematics.Vector3D(0.892523f,  0.684857f,  0.216506f),
                        new Mathematics.Vector3D(0.793353f,  0.608761f,  0.250000f),
                        new Mathematics.Vector3D(0.694184f,  0.532666f,  0.216506f),
                        new Mathematics.Vector3D(0.621587f,  0.476961f,  0.125000f),
                        new Mathematics.Vector3D(0.595015f,  0.456571f,  0.000000f),
                        new Mathematics.Vector3D(0.621587f,  0.476961f, -0.125000f),
                        new Mathematics.Vector3D(0.694184f,  0.532666f, -0.216506f),
                        new Mathematics.Vector3D(0.793353f,  0.608761f, -0.250000f),
                        new Mathematics.Vector3D(0.892523f,  0.684857f, -0.216506f),
                        new Mathematics.Vector3D(0.965119f,  0.740562f, -0.125000f),
                        new Mathematics.Vector3D(0.883883f,  0.883884f,  0.000000f),
                        new Mathematics.Vector3D(0.860200f,  0.860200f,  0.125000f),
                        new Mathematics.Vector3D(0.795495f,  0.795495f,  0.216506f),
                        new Mathematics.Vector3D(0.707107f,  0.707107f,  0.250000f),
                        new Mathematics.Vector3D(0.618718f,  0.618718f,  0.216506f),
                        new Mathematics.Vector3D(0.554014f,  0.554014f,  0.125000f),
                        new Mathematics.Vector3D(0.530330f,  0.530330f,  0.000000f),
                        new Mathematics.Vector3D(0.554014f,  0.554014f, -0.125000f),
                        new Mathematics.Vector3D(0.618718f,  0.618718f, -0.216506f),
                        new Mathematics.Vector3D(0.707107f,  0.707107f, -0.250000f),
                        new Mathematics.Vector3D(0.795495f,  0.795495f, -0.216506f),
                        new Mathematics.Vector3D(0.860200f,  0.860200f, -0.125000f),
                        new Mathematics.Vector3D(0.760952f,  0.991691f,  0.000000f),
                        new Mathematics.Vector3D(0.740562f,  0.965119f,  0.125000f),
                        new Mathematics.Vector3D(0.684857f,  0.892522f,  0.216506f),
                        new Mathematics.Vector3D(0.608762f,  0.793353f,  0.250000f),
                        new Mathematics.Vector3D(0.532666f,  0.694184f,  0.216506f),
                        new Mathematics.Vector3D(0.476961f,  0.621587f,  0.125000f),
                        new Mathematics.Vector3D(0.456571f,  0.595015f,  0.000000f),
                        new Mathematics.Vector3D(0.476961f,  0.621587f, -0.125000f),
                        new Mathematics.Vector3D(0.532666f,  0.694184f, -0.216506f),
                        new Mathematics.Vector3D(0.608762f,  0.793353f, -0.250000f),
                        new Mathematics.Vector3D(0.684857f,  0.892522f, -0.216506f),
                        new Mathematics.Vector3D(0.740562f,  0.965119f, -0.125000f),
                        new Mathematics.Vector3D(0.625000f,  1.082532f,  0.000000f),
                        new Mathematics.Vector3D(0.608253f,  1.053525f,  0.125000f),
                        new Mathematics.Vector3D(0.562500f,  0.974279f,  0.216506f),
                        new Mathematics.Vector3D(0.500000f,  0.866025f,  0.250000f),
                        new Mathematics.Vector3D(0.437500f,  0.757772f,  0.216506f),
                        new Mathematics.Vector3D(0.391747f,  0.678525f,  0.125000f),
                        new Mathematics.Vector3D(0.375000f,  0.649519f,  0.000000f),
                        new Mathematics.Vector3D(0.391747f,  0.678525f, -0.125000f),
                        new Mathematics.Vector3D(0.437500f,  0.757772f, -0.216506f),
                        new Mathematics.Vector3D(0.500000f,  0.866025f, -0.250000f),
                        new Mathematics.Vector3D(0.562500f,  0.974279f, -0.216506f),
                        new Mathematics.Vector3D(0.608253f,  1.053525f, -0.125000f),
                        new Mathematics.Vector3D(0.478355f,  1.154849f,  0.000000f),
                        new Mathematics.Vector3D(0.465537f,  1.123905f,  0.125000f),
                        new Mathematics.Vector3D(0.430519f,  1.039364f,  0.216506f),
                        new Mathematics.Vector3D(0.382684f,  0.923879f,  0.250000f),
                        new Mathematics.Vector3D(0.334848f,  0.808394f,  0.216506f),
                        new Mathematics.Vector3D(0.299830f,  0.723854f,  0.125000f),
                        new Mathematics.Vector3D(0.287013f,  0.692910f,  0.000000f),
                        new Mathematics.Vector3D(0.299830f,  0.723854f, -0.125000f),
                        new Mathematics.Vector3D(0.334848f,  0.808394f, -0.216506f),
                        new Mathematics.Vector3D(0.382684f,  0.923879f, -0.250000f),
                        new Mathematics.Vector3D(0.430519f,  1.039364f, -0.216506f),
                        new Mathematics.Vector3D(0.465537f,  1.123905f, -0.125000f),
                        new Mathematics.Vector3D(0.323524f,  1.207407f,  0.000000f),
                        new Mathematics.Vector3D(0.314855f,  1.175055f,  0.125000f),
                        new Mathematics.Vector3D(0.291171f,  1.086666f,  0.216506f),
                        new Mathematics.Vector3D(0.258819f,  0.965926f,  0.250000f),
                        new Mathematics.Vector3D(0.226467f,  0.845185f,  0.216506f),
                        new Mathematics.Vector3D(0.202783f,  0.756797f,  0.125000f),
                        new Mathematics.Vector3D(0.194114f,  0.724444f,  0.000000f),
                        new Mathematics.Vector3D(0.202783f,  0.756797f, -0.125000f),
                        new Mathematics.Vector3D(0.226467f,  0.845185f, -0.216506f),
                        new Mathematics.Vector3D(0.258819f,  0.965926f, -0.250000f),
                        new Mathematics.Vector3D(0.291171f,  1.086666f, -0.216506f),
                        new Mathematics.Vector3D(0.314855f,  1.175055f, -0.125000f),
                        new Mathematics.Vector3D(0.163158f,  1.239306f,  0.000000f),
                        new Mathematics.Vector3D(0.158786f,  1.206099f,  0.125000f),
                        new Mathematics.Vector3D(0.146842f,  1.115375f,  0.216506f),
                        new Mathematics.Vector3D(0.130526f,  0.991445f,  0.250000f),
                        new Mathematics.Vector3D(0.114210f,  0.867514f,  0.216506f),
                        new Mathematics.Vector3D(0.102266f,  0.776791f,  0.125000f),
                        new Mathematics.Vector3D(0.097895f,  0.743584f,  0.000000f),
                        new Mathematics.Vector3D(0.102266f,  0.776791f, -0.125000f),
                        new Mathematics.Vector3D(0.114210f,  0.867514f, -0.216506f),
                        new Mathematics.Vector3D(0.130526f,  0.991445f, -0.250000f),
                        new Mathematics.Vector3D(0.146842f,  1.115375f, -0.216506f),
                        new Mathematics.Vector3D(0.158786f,  1.206099f, -0.125000f),
                        new Mathematics.Vector3D(0.000000f,  1.250000f,  0.000000f),
                        new Mathematics.Vector3D(0.000000f,  1.216506f,  0.125000f),
                        new Mathematics.Vector3D(0.000000f,  1.125000f,  0.216506f),
                        new Mathematics.Vector3D(0.000000f,  1.000000f,  0.250000f),
                        new Mathematics.Vector3D(0.000000f,  0.875000f,  0.216506f),
                        new Mathematics.Vector3D(0.000000f,  0.783494f,  0.125000f),
                        new Mathematics.Vector3D(0.000000f,  0.750000f,  0.000000f),
                        new Mathematics.Vector3D(0.000000f,  0.783494f, -0.125000f),
                        new Mathematics.Vector3D(0.000000f,  0.875000f, -0.216506f),
                        new Mathematics.Vector3D(0.000000f,  1.000000f, -0.250000f),
                        new Mathematics.Vector3D(0.000000f,  1.125000f, -0.216506f),
                        ...
                        new Mathematics.Vector3D(-0.146842f,  1.115375f,  0.216506f),
                        new Mathematics.Vector3D(-0.130526f,  0.991445f,  0.250000f),
                        new Mathematics.Vector3D(-0.114211f,  0.867514f,  0.216506f),
                        new Mathematics.Vector3D(-0.102267f,  0.776791f,  0.125000f),
                        new Mathematics.Vector3D(-0.097895f,  0.743584f,  0.000000f),
                        new Mathematics.Vector3D(-0.102267f,  0.776791f, -0.125000f),
                        new Mathematics.Vector3D(-0.114211f,  0.867514f, -0.216506f),
                        new Mathematics.Vector3D(-0.130526f,  0.991445f, -0.250000f),
                        ...
                        new Mathematics.Vector3D(-0.323524f,  1.207407f,  0.000000f),
                        new Mathematics.Vector3D(-0.314855f,  1.175055f,  0.125000f),
                        new Mathematics.Vector3D(-0.291171f,  1.086667f,  0.216506f),
                        new Mathematics.Vector3D(-0.258819f,  0.965926f,  0.250000f),
                        new Mathematics.Vector3D(-0.226467f,  0.845185f,  0.216506f),
                        new Mathematics.Vector3D(-0.202783f,  0.756797f,  0.125000f),
                        new Mathematics.Vector3D(-0.194114f,  0.724444f,  0.000000f),
                        ...
                        new Mathematics.Vector3D(-0.291171f,  1.086667f, -0.216506f),
                        new Mathematics.Vector3D(-0.314855f,  1.175055f, -0.125000f),
                        new Mathematics.Vector3D(-0.478354f,  1.154849f,  0.000000f),
                        new Mathematics.Vector3D(-0.465537f,  1.123905f,  0.125000f),
                        new Mathematics.Vector3D(-0.430519f,  1.039364f,  0.216506f),
                        new Mathematics.Vector3D(-0.382684f,  0.923880f,  0.250000f),
                        new Mathematics.Vector3D(-0.334848f,  0.808395f,  0.216506f),
                        new Mathematics.Vector3D(-0.299830f,  0.723854f,  0.125000f),
                        new Mathematics.Vector3D(-0.287013f,  0.692910f,  0.000000f),
                        new Mathematics.Vector3D(-0.299830f,  0.723854f, -0.125000f),
                        new Mathematics.Vector3D(-0.334848f,  0.808395f, -0.216506f),
                        ...
                        new Mathematics.Vector3D(-0.465537f,  1.123905f, -0.125000f),
                        new Mathematics.Vector3D(-0.625000f,  1.082532f,  0.000000f),
                        new Mathematics.Vector3D(-0.608253f,  1.053526f,  0.125000f),
                        new Mathematics.Vector3D(-0.562500f,  0.974279f,  0.216506f),
                        new Mathematics.Vector3D(-0.500000f,  0.866026f,  0.250000f),
                        new Mathematics.Vector3D(-0.437500f,  0.757772f,  0.216506f),
                        new Mathematics.Vector3D(-0.391747f,  0.678525f,  0.125000f),
                        new Mathematics.Vector3D(-0.375000f,  0.649519f,  0.000000f),
                        new Mathematics.Vector3D(-0.391747f,  0.678525f, -0.125000f),
                        ...
                        new Mathematics.Vector3D(-0.562500f,  0.974279f, -0.216506f),
                        new Mathematics.Vector3D(-0.608253f,  1.053526f, -0.125000f),
                        new Mathematics.Vector3D(-0.760952f,  0.991692f,  0.000000f),
                        new Mathematics.Vector3D(-0.740562f,  0.965119f,  0.125000f),
                        new Mathematics.Vector3D(-0.684857f,  0.892522f,  0.216506f),
                        new Mathematics.Vector3D(-0.608761f,  0.793353f,  0.250000f),
                        new Mathematics.Vector3D(-0.532666f,  0.694184f,  0.216506f),
                        new Mathematics.Vector3D(-0.476961f,  0.621587f,  0.125000f),
                        new Mathematics.Vector3D(-0.456571f,  0.595015f,  0.000000f),
                        new Mathematics.Vector3D(-0.476961f,  0.621587f, -0.125000f),
                        ...
                        new Mathematics.Vector3D(-0.684857f,  0.892522f, -0.216506f),
                        new Mathematics.Vector3D(-0.740562f,  0.965119f, -0.125000f),
                        new Mathematics.Vector3D(-0.883884f,  0.883883f,  0.000000f),
                        new Mathematics.Vector3D(-0.860200f,  0.860200f,  0.125000f),
                        new Mathematics.Vector3D(-0.795495f,  0.795495f,  0.216506f),
                        new Mathematics.Vector3D(-0.707107f,  0.707107f,  0.250000f),
                        new Mathematics.Vector3D(-0.618719f,  0.618718f,  0.216506f),
                        new Mathematics.Vector3D(-0.554014f,  0.554013f,  0.125000f),
                        new Mathematics.Vector3D(-0.530330f,  0.530330f,  0.000000f),
                        new Mathematics.Vector3D(-0.554014f,  0.554013f, -0.125000f),
                        new Mathematics.Vector3D(-0.618719f,  0.618718f, -0.216506f),
                        new Mathematics.Vector3D(-0.707107f,  0.707107f, -0.250000f),
                        ...
                        new Mathematics.Vector3D(-0.965119f,  0.740562f, -0.125000f),
                        new Mathematics.Vector3D(-1.082532f,  0.625000f,  0.000000f),
                        new Mathematics.Vector3D(-1.053525f,  0.608254f,  0.125000f),
                        new Mathematics.Vector3D(-0.974279f,  0.562500f,  0.216506f),
                        new Mathematics.Vector3D(-0.866025f,  0.500000f,  0.250000f),
                        new Mathematics.Vector3D(-0.757772f,  0.437500f,  0.216506f),
                        new Mathematics.Vector3D(-0.678525f,  0.391747f,  0.125000f),
                        ...
                        new Mathematics.Vector3D(-1.123905f,  0.465537f,  0.125000f),
                        new Mathematics.Vector3D(-1.039364f,  0.430519f,  0.216506f),
                        new Mathematics.Vector3D(-0.923879f,  0.382683f,  0.250000f),
                        new Mathematics.Vector3D(-0.808394f,  0.334848f,  0.216506f),
                        new Mathematics.Vector3D(-0.723854f,  0.299830f,  0.125000f),
                        new Mathematics.Vector3D(-0.692910f,  0.287013f,  0.000000f),
                        new Mathematics.Vector3D(-0.723854f,  0.299830f, -0.125000f),
                        new Mathematics.Vector3D(-0.808394f,  0.334848f, -0.216506f),
                        ...
                        new Mathematics.Vector3D(-1.239306f,  0.163158f,  0.000000f),
                        new Mathematics.Vector3D(-1.206099f,  0.158786f,  0.125000f),
                        new Mathematics.Vector3D(-1.115375f,  0.146842f,  0.216506f),
                        new Mathematics.Vector3D(-0.991445f,  0.130526f,  0.250000f),
                        new Mathematics.Vector3D(-0.867514f,  0.114211f,  0.216506f),
                        new Mathematics.Vector3D(-0.776791f,  0.102267f,  0.125000f),
                        new Mathematics.Vector3D(-0.743584f,  0.097895f,  0.000000f),
                        new Mathematics.Vector3D(-0.776791f,  0.102267f, -0.125000f),
                        new Mathematics.Vector3D(-0.867514f,  0.114211f, -0.216506f),
                        new Mathematics.Vector3D(-0.991445f,  0.130526f, -0.250000f),
                        ...
                        new Mathematics.Vector3D(-1.086667f, -0.291171f, -0.216506f),
                        new Mathematics.Vector3D(-1.175055f, -0.314855f, -0.125000f),
                        new Mathematics.Vector3D(-1.154850f, -0.478354f,  0.000000f),
                        new Mathematics.Vector3D(-1.123906f, -0.465536f,  0.125000f),
                        new Mathematics.Vector3D(-1.039365f, -0.430518f,  0.216506f),
                        new Mathematics.Vector3D(-0.923880f, -0.382683f,  0.250000f),
                        new Mathematics.Vector3D(-0.808395f, -0.334848f,  0.216506f),
                        new Mathematics.Vector3D(-0.723854f, -0.299830f,  0.125000f),
                        new Mathematics.Vector3D(-0.692910f, -0.287012f,  0.000000f),
                        new Mathematics.Vector3D(-0.723854f, -0.299830f, -0.125000f),
                        new Mathematics.Vector3D(-0.808395f, -0.334848f, -0.216506f),
                        new Mathematics.Vector3D(-0.923880f, -0.382683f, -0.250000f),
                        new Mathematics.Vector3D(-1.039365f, -0.430518f, -0.216506f),
                        new Mathematics.Vector3D(-1.123906f, -0.465536f, -0.125000f),
                        new Mathematics.Vector3D(-1.082532f, -0.625000f,  0.000000f),
                        new Mathematics.Vector3D(-1.053526f, -0.608253f,  0.125000f),
                        new Mathematics.Vector3D(-0.974279f, -0.562500f,  0.216506f),
                        new Mathematics.Vector3D(-0.866026f, -0.500000f,  0.250000f),
                        new Mathematics.Vector3D(-0.757772f, -0.437500f,  0.216506f),
                        new Mathematics.Vector3D(-0.678526f, -0.391747f,  0.125000f),
                        new Mathematics.Vector3D(-0.649519f, -0.375000f,  0.000000f),
                        new Mathematics.Vector3D(-0.678526f, -0.391747f, -0.125000f),
                        new Mathematics.Vector3D(-0.757772f, -0.437500f, -0.216506f),
                        new Mathematics.Vector3D(-0.866026f, -0.500000f, -0.250000f),
                        ...
                        new Mathematics.Vector3D(-0.860200f, -0.860200f, -0.125000f),
                        new Mathematics.Vector3D(-0.760952f, -0.991691f,  0.000000f),
                        new Mathematics.Vector3D(-0.740563f, -0.965119f,  0.125000f),
                        new Mathematics.Vector3D(-0.684857f, -0.892522f,  0.216506f),
                        new Mathematics.Vector3D(-0.608762f, -0.793353f,  0.250000f),
                        new Mathematics.Vector3D(-0.532667f, -0.694184f,  0.216506f),
                        new Mathematics.Vector3D(-0.476961f, -0.621587f,  0.125000f),
                        new Mathematics.Vector3D(-0.456571f, -0.595015f,  0.000000f),
                        new Mathematics.Vector3D(-0.476961f, -0.621587f, -0.125000f),
                        new Mathematics.Vector3D(-0.532667f, -0.694184f, -0.216506f),
                        ...
                        new Mathematics.Vector3D(-0.323524f, -1.207407f,  0.000000f),
                        new Mathematics.Vector3D(-0.314855f, -1.175055f,  0.125000f),
                        new Mathematics.Vector3D(-0.291172f, -1.086666f,  0.216506f),
                        new Mathematics.Vector3D(-0.258819f, -0.965926f,  0.250000f),
                        new Mathematics.Vector3D(-0.226467f, -0.845185f,  0.216506f),
                        new Mathematics.Vector3D(-0.202783f, -0.756797f,  0.125000f),
                        new Mathematics.Vector3D(-0.194114f, -0.724444f,  0.000000f),
                        ...
                        new Mathematics.Vector3D(-0.291172f, -1.086666f, -0.216506f),
                        new Mathematics.Vector3D(-0.314855f, -1.175055f, -0.125000f),
                        new Mathematics.Vector3D(-0.163159f, -1.239306f,  0.000000f),
                        new Mathematics.Vector3D(-0.158787f, -1.206099f,  0.125000f),
                        new Mathematics.Vector3D(-0.146843f, -1.115375f,  0.216506f),
                        new Mathematics.Vector3D(-0.130527f, -0.991445f,  0.250000f),
                        new Mathematics.Vector3D(-0.114211f, -0.867514f,  0.216506f),
                        new Mathematics.Vector3D(-0.102267f, -0.776791f,  0.125000f),
                        new Mathematics.Vector3D(-0.097895f, -0.743584f,  0.000000f),
                        new Mathematics.Vector3D(-0.102267f, -0.776791f, -0.125000f),
                        ...
                        new Mathematics.Vector3D(0.146842f, -1.115375f, -0.216506f),
                        new Mathematics.Vector3D(0.158786f, -1.206099f, -0.125000f),
                        new Mathematics.Vector3D(0.323523f, -1.207407f,  0.000000f),
                        new Mathematics.Vector3D(0.314855f, -1.175055f,  0.125000f),
                        new Mathematics.Vector3D(0.291171f, -1.086667f,  0.216506f),
                        new Mathematics.Vector3D(0.258819f, -0.965926f,  0.250000f),
                        new Mathematics.Vector3D(0.226466f, -0.845185f,  0.216506f),
                        new Mathematics.Vector3D(0.202783f, -0.756797f,  0.125000f),
                        new Mathematics.Vector3D(0.194114f, -0.724445f,  0.000000f),
                        new Mathematics.Vector3D(0.202783f, -0.756797f, -0.125000f),
                        new Mathematics.Vector3D(0.226466f, -0.845185f, -0.216506f),
                        new Mathematics.Vector3D(0.258819f, -0.965926f, -0.250000f),
                        new Mathematics.Vector3D(0.291171f, -1.086667f, -0.216506f),
                        ...
                        new Mathematics.Vector3D(0.608253f, -1.053525f, -0.125000f),
                        new Mathematics.Vector3D(0.760952f, -0.991692f,  0.000000f),
                        new Mathematics.Vector3D(0.740562f, -0.965120f,  0.125000f),
                        new Mathematics.Vector3D(0.684856f, -0.892523f,  0.216506f),
                        new Mathematics.Vector3D(0.608761f, -0.793354f,  0.250000f),
                        new Mathematics.Vector3D(0.532666f, -0.694184f,  0.216506f),
                        new Mathematics.Vector3D(0.476961f, -0.621587f,  0.125000f),
                        new Mathematics.Vector3D(0.456571f, -0.595015f,  0.000000f),
                        new Mathematics.Vector3D(0.476961f, -0.621587f, -0.125000f),
                        ...
                        new Mathematics.Vector3D(0.740562f, -0.965120f, -0.125000f),
                        new Mathematics.Vector3D(0.883883f, -0.883884f,  0.000000f),
                        new Mathematics.Vector3D(0.860199f, -0.860200f,  0.125000f),
                        new Mathematics.Vector3D(0.795495f, -0.795496f,  0.216506f),
                        new Mathematics.Vector3D(0.707106f, -0.707107f,  0.250000f),
                        new Mathematics.Vector3D(0.618718f, -0.618719f,  0.216506f),
                        new Mathematics.Vector3D(0.554013f, -0.554014f,  0.125000f),
                        new Mathematics.Vector3D(0.530330f, -0.530330f,  0.000000f),
                        new Mathematics.Vector3D(0.554013f, -0.554014f, -0.125000f),
                        new Mathematics.Vector3D(0.618718f, -0.618719f, -0.216506f),
                        new Mathematics.Vector3D(0.707106f, -0.707107f, -0.250000f),
                        ...
                        new Mathematics.Vector3D(0.974279f, -0.562500f, -0.216506f),
                        new Mathematics.Vector3D(1.053525f, -0.608253f, -0.125000f),
                        new Mathematics.Vector3D(1.154849f, -0.478355f,  0.000000f),
                        new Mathematics.Vector3D(1.123905f, -0.465537f,  0.125000f),
                        new Mathematics.Vector3D(1.039364f, -0.430519f,  0.216506f),
                        new Mathematics.Vector3D(0.923879f, -0.382684f,  0.250000f),
                        new Mathematics.Vector3D(0.808394f, -0.334848f,  0.216506f),
                        new Mathematics.Vector3D(0.723854f, -0.299830f,  0.125000f),
                        new Mathematics.Vector3D(0.692910f, -0.287013f,  0.000000f),
                        new Mathematics.Vector3D(0.723854f, -0.299830f, -0.125000f),
                        ...
                        new Mathematics.Vector3D(1.039364f, -0.430519f, -0.216506f),
                        new Mathematics.Vector3D(1.123905f, -0.465537f, -0.125000f),
                        new Mathematics.Vector3D(1.207407f, -0.323523f,  0.000000f),
                        new Mathematics.Vector3D(1.175055f, -0.314855f,  0.125000f),
                        new Mathematics.Vector3D(1.086667f, -0.291171f,  0.216506f),
                        new Mathematics.Vector3D(0.965926f, -0.258819f,  0.250000f),
                        new Mathematics.Vector3D(0.845185f, -0.226466f,  0.216506f),
                        new Mathematics.Vector3D(0.756797f, -0.202783f,  0.125000f),
                        new Mathematics.Vector3D(0.724444f, -0.194114f,  0.000000f),
                        new Mathematics.Vector3D(0.756797f, -0.202783f, -0.125000f),
                        new Mathematics.Vector3D(0.845185f, -0.226466f, -0.216506f),
                    ...
                    normals = new List<Mathematics.Vector3D>()
                    {
                        new Mathematics.Vector3D( 0.963996f,  0.063183f,  0.258302f),
                        new Mathematics.Vector3D( 0.706349f,  0.046296f,  0.706349f),
                        new Mathematics.Vector3D( 0.258782f,  0.016961f,  0.965787f),
                        new Mathematics.Vector3D(-0.258782f, -0.016961f,  0.965787f),
                        new Mathematics.Vector3D(-0.706349f, -0.046297f,  0.706349f),
                        new Mathematics.Vector3D(-0.963996f, -0.063183f,  0.258302f),
                        new Mathematics.Vector3D(-0.963996f, -0.063183f, -0.258302f),
                        new Mathematics.Vector3D(-0.706349f, -0.046297f, -0.706349f),
                        new Mathematics.Vector3D(-0.258782f, -0.016961f, -0.965787f),
                        ...
                        new Mathematics.Vector3D( 0.706349f,  0.046296f, -0.706349f),
                        new Mathematics.Vector3D( 0.963996f,  0.063183f, -0.258302f),
                        new Mathematics.Vector3D( 0.947502f,  0.188469f,  0.258302f),
                        new Mathematics.Vector3D( 0.694263f,  0.138097f,  0.706349f),
                        new Mathematics.Vector3D( 0.254354f,  0.050594f,  0.965787f),
                        new Mathematics.Vector3D(-0.254354f, -0.050594f,  0.965787f),
                        new Mathematics.Vector3D(-0.694263f, -0.138097f,  0.706349f),
                        new Mathematics.Vector3D(-0.947502f, -0.188469f,  0.258302f),
                        new Mathematics.Vector3D(-0.947502f, -0.188469f, -0.258302f),
                        ...
                        new Mathematics.Vector3D( 0.694263f,  0.138097f, -0.706349f),
                        new Mathematics.Vector3D( 0.947502f,  0.188469f, -0.258302f),
                        new Mathematics.Vector3D( 0.914795f,  0.310532f,  0.258301f),
                        new Mathematics.Vector3D( 0.670297f,  0.227536f,  0.706349f),
                        new Mathematics.Vector3D( 0.245574f,  0.083361f,  0.965787f),
                        new Mathematics.Vector3D(-0.245574f, -0.083361f,  0.965787f),
                        new Mathematics.Vector3D(-0.670298f, -0.227535f,  0.706348f),
                        new Mathematics.Vector3D(-0.914795f, -0.310531f,  0.258302f),
                        new Mathematics.Vector3D(-0.914795f, -0.310531f, -0.258302f),
                        new Mathematics.Vector3D(-0.670298f, -0.227535f, -0.706348f),
                        new Mathematics.Vector3D(-0.245574f, -0.083361f, -0.965787f),
                        new Mathematics.Vector3D( 0.245574f,  0.083361f, -0.965787f),
                        new Mathematics.Vector3D( 0.670297f,  0.227536f, -0.706349f),
                        new Mathematics.Vector3D( 0.914795f,  0.310532f, -0.258301f),
                        new Mathematics.Vector3D( 0.866437f,  0.427279f,  0.258302f),
                        new Mathematics.Vector3D( 0.634864f,  0.313080f,  0.706349f),
                        new Mathematics.Vector3D( 0.232592f,  0.114702f,  0.965787f),
                        new Mathematics.Vector3D(-0.232592f, -0.114702f,  0.965787f),
                        new Mathematics.Vector3D(-0.634864f, -0.313081f,  0.706349f),
                        new Mathematics.Vector3D(-0.866436f, -0.427280f,  0.258302f),
                        new Mathematics.Vector3D(-0.866436f, -0.427280f, -0.258302f),
                        new Mathematics.Vector3D(-0.634864f, -0.313081f, -0.706349f),
                        new Mathematics.Vector3D(-0.232592f, -0.114702f, -0.965787f),
                        new Mathematics.Vector3D( 0.232592f,  0.114702f, -0.965787f),
                        new Mathematics.Vector3D( 0.634864f,  0.313080f, -0.706349f),
                        new Mathematics.Vector3D( 0.866437f,  0.427279f, -0.258302f),
                        new Mathematics.Vector3D( 0.803253f,  0.536716f,  0.258302f),
                        new Mathematics.Vector3D( 0.588568f,  0.393268f,  0.706348f),
                        new Mathematics.Vector3D( 0.215631f,  0.144080f,  0.965787f),
                        new Mathematics.Vector3D(-0.215631f, -0.144080f,  0.965787f),
                        new Mathematics.Vector3D(-0.588567f, -0.393268f,  0.706349f),
                        new Mathematics.Vector3D(-0.803253f, -0.536716f,  0.258302f),
                        new Mathematics.Vector3D(-0.803253f, -0.536716f, -0.258302f),
                        new Mathematics.Vector3D(-0.588567f, -0.393268f, -0.706349f),
                        new Mathematics.Vector3D(-0.215631f, -0.144080f, -0.965787f),
                        ...
                        new Mathematics.Vector3D( 0.588568f,  0.393268f, -0.706348f),
                        new Mathematics.Vector3D( 0.803253f,  0.536716f, -0.258302f),
                        new Mathematics.Vector3D( 0.726325f,  0.636971f,  0.258302f),
                        new Mathematics.Vector3D( 0.532200f,  0.466727f,  0.706349f),
                        new Mathematics.Vector3D( 0.194980f,  0.170993f,  0.965787f),
                        new Mathematics.Vector3D(-0.194980f, -0.170993f,  0.965787f),
                        new Mathematics.Vector3D(-0.532200f, -0.466727f,  0.706349f),
                        new Mathematics.Vector3D(-0.726325f, -0.636971f,  0.258302f),
                        new Mathematics.Vector3D(-0.726325f, -0.636971f, -0.258302f),
                        ...
                        new Mathematics.Vector3D( 0.532200f,  0.466727f, -0.706349f),
                        new Mathematics.Vector3D( 0.726325f,  0.636971f, -0.258302f),
                        new Mathematics.Vector3D( 0.636970f,  0.726326f,  0.258302f),
                        new Mathematics.Vector3D( 0.466727f,  0.532200f,  0.706349f),
                        new Mathematics.Vector3D( 0.170993f,  0.194980f,  0.965787f),
                        new Mathematics.Vector3D(-0.170993f, -0.194980f,  0.965787f),
                        new Mathematics.Vector3D(-0.466727f, -0.532200f,  0.706349f),
                        new Mathematics.Vector3D(-0.636971f, -0.726325f,  0.258302f),
                        new Mathematics.Vector3D(-0.636971f, -0.726325f, -0.258302f),
                        new Mathematics.Vector3D(-0.466727f, -0.532200f, -0.706349f),
                        new Mathematics.Vector3D(-0.170993f, -0.194980f, -0.965787f),
                        new Mathematics.Vector3D( 0.170993f,  0.194980f, -0.965787f),
                        new Mathematics.Vector3D( 0.466727f,  0.532200f, -0.706349f),
                        new Mathematics.Vector3D( 0.636970f,  0.726326f, -0.258302f),
                        new Mathematics.Vector3D( 0.536717f,  0.803253f,  0.258301f),
                        new Mathematics.Vector3D( 0.393268f,  0.588567f,  0.706349f),
                        new Mathematics.Vector3D( 0.144080f,  0.215631f,  0.965787f),
                        new Mathematics.Vector3D(-0.144080f, -0.215631f,  0.965787f),
                        new Mathematics.Vector3D(-0.393268f, -0.588568f,  0.706349f),
                        new Mathematics.Vector3D(-0.536717f, -0.803253f,  0.258302f),
                        new Mathematics.Vector3D(-0.536717f, -0.803253f, -0.258302f),
                        new Mathematics.Vector3D(-0.393268f, -0.588568f, -0.706349f),
                        new Mathematics.Vector3D(-0.144080f, -0.215631f, -0.965787f),
                        new Mathematics.Vector3D( 0.144080f,  0.215631f, -0.965787f),
                        new Mathematics.Vector3D( 0.393268f,  0.588567f, -0.706349f),
                        new Mathematics.Vector3D( 0.536717f,  0.803253f, -0.258301f),
                        new Mathematics.Vector3D( 0.427279f,  0.866437f,  0.258302f),
                        new Mathematics.Vector3D( 0.313080f,  0.634864f,  0.706348f),
                        new Mathematics.Vector3D( 0.114702f,  0.232592f,  0.965787f),
                        new Mathematics.Vector3D(-0.114702f, -0.232592f,  0.965787f),
                        new Mathematics.Vector3D(-0.313080f, -0.634864f,  0.706349f),
                        new Mathematics.Vector3D(-0.427279f, -0.866437f,  0.258302f),
                        new Mathematics.Vector3D(-0.427279f, -0.866437f, -0.258302f),
                        new Mathematics.Vector3D(-0.313080f, -0.634864f, -0.706349f),
                        new Mathematics.Vector3D(-0.114702f, -0.232592f, -0.965787f),
                        ...
                        new Mathematics.Vector3D( 0.313080f,  0.634864f, -0.706348f),
                        new Mathematics.Vector3D( 0.427279f,  0.866437f, -0.258302f),
                        new Mathematics.Vector3D( 0.310532f,  0.914795f,  0.258302f),
                        new Mathematics.Vector3D( 0.227536f,  0.670298f,  0.706349f),
                        new Mathematics.Vector3D( 0.083361f,  0.245574f,  0.965787f),
                        new Mathematics.Vector3D(-0.083361f, -0.245574f,  0.965787f),
                        new Mathematics.Vector3D(-0.227536f, -0.670298f,  0.706349f),
                        new Mathematics.Vector3D(-0.310531f, -0.914795f,  0.258302f),
                        new Mathematics.Vector3D(-0.310531f, -0.914795f, -0.258302f),
                        new Mathematics.Vector3D(-0.227536f, -0.670298f, -0.706349f),
                        new Mathematics.Vector3D(-0.083361f, -0.245574f, -0.965787f),
                        new Mathematics.Vector3D( 0.083361f,  0.245574f, -0.965787f),
                        new Mathematics.Vector3D( 0.227536f,  0.670298f, -0.706349f),
                        new Mathematics.Vector3D( 0.310532f,  0.914795f, -0.258302f),
                        new Mathematics.Vector3D( 0.188470f,  0.947502f,  0.258302f),
                        new Mathematics.Vector3D( 0.138097f,  0.694262f,  0.706349f),
                        new Mathematics.Vector3D( 0.050594f,  0.254354f,  0.965787f),
                        new Mathematics.Vector3D(-0.050594f, -0.254354f,  0.965787f),
                        new Mathematics.Vector3D(-0.138097f, -0.694263f,  0.706349f),
                        new Mathematics.Vector3D(-0.188470f, -0.947502f,  0.258302f),
                        new Mathematics.Vector3D(-0.188470f, -0.947502f, -0.258302f),
                        new Mathematics.Vector3D(-0.138097f, -0.694263f, -0.706349f),
                        new Mathematics.Vector3D(-0.050594f, -0.254354f, -0.965787f),
                        ...
                        new Mathematics.Vector3D( 0.138097f,  0.694262f, -0.706349f),
                        new Mathematics.Vector3D( 0.188470f,  0.947502f, -0.258302f),
                        new Mathematics.Vector3D( 0.063184f,  0.963996f,  0.258302f),
                        new Mathematics.Vector3D( 0.046297f,  0.706348f,  0.706349f),
                        new Mathematics.Vector3D( 0.016962f,  0.258782f,  0.965787f),
                        new Mathematics.Vector3D(-0.016961f, -0.258782f,  0.965787f),
                        new Mathematics.Vector3D(-0.046297f, -0.706348f,  0.706349f),
                        new Mathematics.Vector3D(-0.063184f, -0.963996f,  0.258302f),
                        new Mathematics.Vector3D(-0.063184f, -0.963996f, -0.258302f),
                        new Mathematics.Vector3D(-0.046297f, -0.706348f, -0.706349f),
                        ...
                        new Mathematics.Vector3D( 0.046297f,  0.706348f, -0.706349f),
                        new Mathematics.Vector3D( 0.063184f,  0.963996f, -0.258302f),
                        new Mathematics.Vector3D(-0.063184f,  0.963996f,  0.258303f),
                        new Mathematics.Vector3D(-0.046297f,  0.706349f,  0.706349f),
                        new Mathematics.Vector3D(-0.016961f,  0.258782f,  0.965787f),
                        new Mathematics.Vector3D( 0.016962f, -0.258782f,  0.965787f),
                        new Mathematics.Vector3D( 0.046297f, -0.706349f,  0.706349f),
                        new Mathematics.Vector3D( 0.063184f, -0.963996f,  0.258302f),
                        ...
                        new Mathematics.Vector3D(-0.138097f,  0.694263f, -0.706349f),
                        new Mathematics.Vector3D(-0.188470f,  0.947502f, -0.258302f),
                        new Mathematics.Vector3D(-0.310532f,  0.914795f,  0.258301f),
                        new Mathematics.Vector3D(-0.227536f,  0.670298f,  0.706349f),
                        new Mathematics.Vector3D(-0.083361f,  0.245574f,  0.965787f),
                        new Mathematics.Vector3D( 0.083361f, -0.245574f,  0.965787f),
                        new Mathematics.Vector3D( 0.227536f, -0.670298f,  0.706349f),
                        new Mathematics.Vector3D( 0.310531f, -0.914796f,  0.258302f),
                        new Mathematics.Vector3D( 0.310531f, -0.914796f, -0.258302f),
                        new Mathematics.Vector3D( 0.227536f, -0.670298f, -0.706349f),
                        new Mathematics.Vector3D( 0.083361f, -0.245574f, -0.965787f),
                        new Mathematics.Vector3D(-0.083361f,  0.245574f, -0.965787f),
                        new Mathematics.Vector3D(-0.227536f,  0.670298f, -0.706349f),
                        new Mathematics.Vector3D(-0.310532f,  0.914795f, -0.258301f),
                        new Mathematics.Vector3D(-0.427279f,  0.866437f,  0.258301f),
                        new Mathematics.Vector3D(-0.313080f,  0.634864f,  0.706349f),
                        new Mathematics.Vector3D(-0.114702f,  0.232592f,  0.965787f),
                        new Mathematics.Vector3D( 0.114702f, -0.232592f,  0.965787f),
                        new Mathematics.Vector3D( 0.313080f, -0.634864f,  0.706349f),
                        ...
                        new Mathematics.Vector3D(-0.393268f,  0.588567f, -0.706349f),
                        new Mathematics.Vector3D(-0.536717f,  0.803253f, -0.258301f),
                        new Mathematics.Vector3D(-0.636971f,  0.726325f,  0.258301f),
                        new Mathematics.Vector3D(-0.466727f,  0.532200f,  0.706349f),
                        new Mathematics.Vector3D(-0.170993f,  0.194980f,  0.965787f),
                        new Mathematics.Vector3D( 0.170993f, -0.194980f,  0.965787f),
                        new Mathematics.Vector3D( 0.466728f, -0.532200f,  0.706349f),
                        new Mathematics.Vector3D( 0.636971f, -0.726325f,  0.258302f),
                        new Mathematics.Vector3D( 0.636971f, -0.726325f, -0.258302f),
                        new Mathematics.Vector3D( 0.466728f, -0.532200f, -0.706349f),
                        new Mathematics.Vector3D( 0.170993f, -0.194980f, -0.965787f),
                        ...
                        new Mathematics.Vector3D(-0.466727f,  0.532200f, -0.706349f),
                        new Mathematics.Vector3D(-0.636971f,  0.726325f, -0.258301f),
                        new Mathematics.Vector3D(-0.726326f,  0.636971f,  0.258301f),
                        new Mathematics.Vector3D(-0.532200f,  0.466727f,  0.706349f),
                        new Mathematics.Vector3D(-0.194980f,  0.170993f,  0.965787f),
                        new Mathematics.Vector3D( 0.194980f, -0.170993f,  0.965787f),
                        new Mathematics.Vector3D( 0.532200f, -0.466727f,  0.706349f),
                        ...
                        new Mathematics.Vector3D(-0.532200f,  0.466727f, -0.706349f),
                        new Mathematics.Vector3D(-0.726326f,  0.636971f, -0.258301f),
                        new Mathematics.Vector3D(-0.803253f,  0.536717f,  0.258301f),
                        new Mathematics.Vector3D(-0.588567f,  0.393269f,  0.706349f),
                        new Mathematics.Vector3D(-0.215631f,  0.144080f,  0.965787f),
                        new Mathematics.Vector3D( 0.215631f, -0.144080f,  0.965787f),
                        new Mathematics.Vector3D( 0.588567f, -0.393268f,  0.706349f),
                        new Mathematics.Vector3D( 0.803253f, -0.536717f,  0.258302f),
                        new Mathematics.Vector3D( 0.803253f, -0.536717f, -0.258302f),
                        new Mathematics.Vector3D( 0.588567f, -0.393268f, -0.706349f),
                        new Mathematics.Vector3D( 0.215631f, -0.144080f, -0.965787f),
                        new Mathematics.Vector3D(-0.215631f,  0.144080f, -0.965787f),
                        ...
                        new Mathematics.Vector3D(-0.803253f,  0.536717f, -0.258301f),
                        new Mathematics.Vector3D(-0.866437f,  0.427279f,  0.258302f),
                        new Mathematics.Vector3D(-0.634865f,  0.313080f,  0.706348f),
                        new Mathematics.Vector3D(-0.232592f,  0.114702f,  0.965787f),
                        new Mathematics.Vector3D( 0.232592f, -0.114702f,  0.965787f),
                        new Mathematics.Vector3D( 0.634864f, -0.313080f,  0.706349f),
                        new Mathematics.Vector3D( 0.866437f, -0.427278f,  0.258302f),
                        new Mathematics.Vector3D( 0.866437f, -0.427278f, -0.258302f),
                        new Mathematics.Vector3D( 0.634864f, -0.313080f, -0.706349f),
                        new Mathematics.Vector3D( 0.232592f, -0.114702f, -0.965787f),
                        new Mathematics.Vector3D(-0.232592f,  0.114702f, -0.965787f),
                        new Mathematics.Vector3D(-0.634865f,  0.313080f, -0.706348f),
                        new Mathematics.Vector3D(-0.866437f,  0.427279f, -0.258302f),
                        new Mathematics.Vector3D(-0.914795f,  0.310532f,  0.258302f),
                        new Mathematics.Vector3D(-0.670298f,  0.227536f,  0.706348f),
                        new Mathematics.Vector3D(-0.245574f,  0.083361f,  0.965787f),
                        new Mathematics.Vector3D( 0.245574f, -0.083361f,  0.965787f),
                        new Mathematics.Vector3D( 0.670298f, -0.227536f,  0.706349f),
                        new Mathematics.Vector3D( 0.914795f, -0.310532f,  0.258302f),
                        new Mathematics.Vector3D( 0.914795f, -0.310532f, -0.258302f),
                        new Mathematics.Vector3D( 0.670298f, -0.227536f, -0.706349f),
                        new Mathematics.Vector3D( 0.245574f, -0.083361f, -0.965787f),
                        ...
                        new Mathematics.Vector3D(-0.670298f,  0.227536f, -0.706348f),
                        new Mathematics.Vector3D(-0.914795f,  0.310532f, -0.258302f),
                        new Mathematics.Vector3D(-0.947502f,  0.188470f,  0.258302f),
                        new Mathematics.Vector3D(-0.694263f,  0.138097f,  0.706349f),
                        new Mathematics.Vector3D(-0.254354f,  0.050594f,  0.965787f),
                        new Mathematics.Vector3D( 0.254354f, -0.050594f,  0.965787f),
                        new Mathematics.Vector3D( 0.694263f, -0.138097f,  0.706349f),
                        ...
                        new Mathematics.Vector3D(-0.947502f,  0.188470f, -0.258302f),
                        new Mathematics.Vector3D(-0.963996f,  0.063183f,  0.258302f),
                        new Mathematics.Vector3D(-0.706348f,  0.046297f,  0.706349f),
                        new Mathematics.Vector3D(-0.258782f,  0.016961f,  0.965787f),
                        new Mathematics.Vector3D( 0.258782f, -0.016961f,  0.965787f),
                        new Mathematics.Vector3D( 0.706349f, -0.046297f,  0.706349f),
                        new Mathematics.Vector3D( 0.963996f, -0.063183f,  0.258302f),
                        ...
                        new Mathematics.Vector3D(-0.963996f,  0.063183f, -0.258302f),
                        new Mathematics.Vector3D(-0.963996f, -0.063183f,  0.258302f),
                        new Mathematics.Vector3D(-0.706348f, -0.046296f,  0.706349f),
                        new Mathematics.Vector3D(-0.258782f, -0.016961f,  0.965787f),
                        new Mathematics.Vector3D( 0.258782f,  0.016961f,  0.965787f),
                        new Mathematics.Vector3D( 0.706349f,  0.046297f,  0.706349f),
                        new Mathematics.Vector3D( 0.963996f,  0.063183f,  0.258302f),
                        ...
                        new Mathematics.Vector3D(-0.694263f, -0.138097f, -0.706349f),
                        new Mathematics.Vector3D(-0.947502f, -0.188470f, -0.258302f),
                        new Mathematics.Vector3D(-0.914795f, -0.310531f,  0.258301f),
                        new Mathematics.Vector3D(-0.670298f, -0.227536f,  0.706349f),
                        new Mathematics.Vector3D(-0.245574f, -0.083361f,  0.965787f),
                        new Mathematics.Vector3D( 0.245574f,  0.083361f,  0.965787f),
                        new Mathematics.Vector3D( 0.670298f,  0.227535f,  0.706349f),
                        new Mathematics.Vector3D( 0.914795f,  0.310532f,  0.258302f),
                        new Mathematics.Vector3D( 0.914795f,  0.310532f, -0.258302f),
                        new Mathematics.Vector3D( 0.670298f,  0.227535f, -0.706349f),
                        new Mathematics.Vector3D( 0.245574f,  0.083361f, -0.965787f),
                        ...
                        new Mathematics.Vector3D(-0.670298f, -0.227536f, -0.706349f),
                        new Mathematics.Vector3D(-0.914795f, -0.310531f, -0.258301f),
                        new Mathematics.Vector3D(-0.866437f, -0.427278f,  0.258301f),
                        new Mathematics.Vector3D(-0.634864f, -0.313079f,  0.706349f),
                        new Mathematics.Vector3D(-0.232593f, -0.114702f,  0.965787f),
                        new Mathematics.Vector3D( 0.232593f,  0.114702f,  0.965787f),
                        new Mathematics.Vector3D( 0.634864f,  0.313080f,  0.706349f),
                        new Mathematics.Vector3D( 0.866437f,  0.427279f,  0.258302f),
                        new Mathematics.Vector3D( 0.866437f,  0.427279f, -0.258302f),
                        ...
                        new Mathematics.Vector3D(-0.636971f, -0.726325f, -0.258301f),
                        new Mathematics.Vector3D(-0.536717f, -0.803253f,  0.258301f),
                        new Mathematics.Vector3D(-0.393269f, -0.588567f,  0.706349f),
                        new Mathematics.Vector3D(-0.144080f, -0.215631f,  0.965787f),
                        new Mathematics.Vector3D( 0.144080f,  0.215631f,  0.965787f),
                        new Mathematics.Vector3D( 0.393269f,  0.588567f,  0.706349f),
                        new Mathematics.Vector3D( 0.536717f,  0.803253f,  0.258302f),
                        ...
                        new Mathematics.Vector3D(-0.427279f, -0.866437f, -0.258301f),
                        new Mathematics.Vector3D(-0.310532f, -0.914795f,  0.258302f),
                        new Mathematics.Vector3D(-0.227535f, -0.670298f,  0.706348f),
                        new Mathematics.Vector3D(-0.083361f, -0.245574f,  0.965787f),
                        new Mathematics.Vector3D( 0.083361f,  0.245574f,  0.965787f),
                        new Mathematics.Vector3D( 0.227536f,  0.670298f,  0.706349f),
                        new Mathematics.Vector3D( 0.310531f,  0.914795f,  0.258302f),
                        ...
                        new Mathematics.Vector3D(-0.227535f, -0.670298f, -0.706348f),
                        new Mathematics.Vector3D(-0.310532f, -0.914795f, -0.258302f),
                        new Mathematics.Vector3D(-0.188470f, -0.947501f,  0.258302f),
                        new Mathematics.Vector3D(-0.138098f, -0.694263f,  0.706348f),
                        new Mathematics.Vector3D(-0.050594f, -0.254354f,  0.965787f),
                        new Mathematics.Vector3D( 0.050594f,  0.254354f,  0.965787f),
                        new Mathematics.Vector3D( 0.138097f,  0.694263f,  0.706349f),
                        new Mathematics.Vector3D( 0.188469f,  0.947502f,  0.258302f),
                        new Mathematics.Vector3D( 0.188469f,  0.947502f, -0.258302f),
                        new Mathematics.Vector3D( 0.138097f,  0.694263f, -0.706349f),
                        new Mathematics.Vector3D( 0.050594f,  0.254354f, -0.965787f),
                        new Mathematics.Vector3D(-0.050594f, -0.254354f, -0.965787f),
                        new Mathematics.Vector3D(-0.138098f, -0.694263f, -0.706348f),
                        new Mathematics.Vector3D(-0.188470f, -0.947501f, -0.258302f),
                        new Mathematics.Vector3D(-0.063185f, -0.963996f,  0.258303f),
                        new Mathematics.Vector3D(-0.046297f, -0.706349f,  0.706348f),
                        new Mathematics.Vector3D(-0.016962f, -0.258782f,  0.965787f),
                        new Mathematics.Vector3D( 0.016962f,  0.258782f,  0.965787f),
                        new Mathematics.Vector3D( 0.046297f,  0.706348f,  0.706349f),
                        new Mathematics.Vector3D( 0.063185f,  0.963996f,  0.258302f),
                        new Mathematics.Vector3D( 0.063185f,  0.963996f, -0.258302f),
                        new Mathematics.Vector3D( 0.046297f,  0.706348f, -0.706349f),
                        new Mathematics.Vector3D( 0.016962f,  0.258782f, -0.965787f),
                        new Mathematics.Vector3D(-0.016962f, -0.258782f, -0.965787f),
                        ...
                        new Mathematics.Vector3D( 0.050594f, -0.254354f,  0.965787f),
                        new Mathematics.Vector3D(-0.050594f,  0.254354f,  0.965787f),
                        new Mathematics.Vector3D(-0.138098f,  0.694263f,  0.706349f),
                        new Mathematics.Vector3D(-0.188470f,  0.947502f,  0.258301f),
                        new Mathematics.Vector3D(-0.188470f,  0.947502f, -0.258301f),
                        new Mathematics.Vector3D(-0.138098f,  0.694263f, -0.706349f),
                        new Mathematics.Vector3D(-0.050594f,  0.254354f, -0.965787f),
                        new Mathematics.Vector3D( 0.050594f, -0.254354f, -0.965787f),
                        ...
                        new Mathematics.Vector3D( 0.188470f, -0.947502f, -0.258302f),
                        new Mathematics.Vector3D( 0.310531f, -0.914795f,  0.258302f),
                        new Mathematics.Vector3D( 0.227536f, -0.670298f,  0.706348f),
                        new Mathematics.Vector3D( 0.083361f, -0.245574f,  0.965787f),
                        new Mathematics.Vector3D(-0.083361f,  0.245574f,  0.965787f),
                        new Mathematics.Vector3D(-0.227535f,  0.670298f,  0.706349f),
                        new Mathematics.Vector3D(-0.310531f,  0.914795f,  0.258301f),
                        new Mathematics.Vector3D(-0.310531f,  0.914795f, -0.258301f),
                        new Mathematics.Vector3D(-0.227535f,  0.670298f, -0.706349f),
                        new Mathematics.Vector3D(-0.083361f,  0.245574f, -0.965787f),
                        new Mathematics.Vector3D( 0.083361f, -0.245574f, -0.965787f),
                        ...
                        new Mathematics.Vector3D( 0.313080f, -0.634864f, -0.706348f),
                        new Mathematics.Vector3D( 0.427279f, -0.866437f, -0.258302f),
                        new Mathematics.Vector3D( 0.536716f, -0.803253f,  0.258302f),
                        new Mathematics.Vector3D( 0.393268f, -0.588568f,  0.706349f),
                        new Mathematics.Vector3D( 0.144080f, -0.215631f,  0.965787f),
                        new Mathematics.Vector3D(-0.144080f,  0.215631f,  0.965787f),
                        new Mathematics.Vector3D(-0.393268f,  0.588568f,  0.706349f),
                        ...
                        new Mathematics.Vector3D( 0.536716f, -0.803253f, -0.258302f),
                        new Mathematics.Vector3D( 0.636970f, -0.726326f,  0.258302f),
                        new Mathematics.Vector3D( 0.466727f, -0.532201f,  0.706348f),
                        new Mathematics.Vector3D( 0.170993f, -0.194980f,  0.965787f),
                        new Mathematics.Vector3D(-0.170993f,  0.194980f,  0.965787f),
                        new Mathematics.Vector3D(-0.466727f,  0.532200f,  0.706349f),
                        new Mathematics.Vector3D(-0.636970f,  0.726326f,  0.258302f),
                        ...
                        new Mathematics.Vector3D( 0.588568f, -0.393268f, -0.706348f),
                        new Mathematics.Vector3D( 0.803253f, -0.536716f, -0.258302f),
                        new Mathematics.Vector3D( 0.866436f, -0.427279f,  0.258302f),
                        new Mathematics.Vector3D( 0.634864f, -0.313080f,  0.706348f),
                        new Mathematics.Vector3D( 0.232592f, -0.114702f,  0.965787f),
                        new Mathematics.Vector3D(-0.232592f,  0.114702f,  0.965787f),
                        new Mathematics.Vector3D(-0.634864f,  0.313080f,  0.706349f),
                        new Mathematics.Vector3D(-0.866437f,  0.427280f,  0.258302f),
                        new Mathematics.Vector3D(-0.866437f,  0.427280f, -0.258302f),
                        new Mathematics.Vector3D(-0.634864f,  0.313080f, -0.706349f),
                        new Mathematics.Vector3D(-0.232592f,  0.114702f, -0.965787f),
                        new Mathematics.Vector3D( 0.232592f, -0.114702f, -0.965787f),
        ...
        #region Event Handlers
            ...
            {
                this.rotationSpeed.X = (float)(e.NewValue);
            }

            private void Slider_ValueChanged_1(object sender, RoutedPropertyChangedEventArgs<double> e)
            {
                this.rotationSpeed.Y = (float)(e.NewValue);
            }

            private void Slider_ValueChanged_2(object sender, RoutedPropertyChangedEventArgs<double> e)
            {
                this.rotationSpeed.Z = (float)(e.NewValue);
            }

            private void Slider_ValueChanged_3(object sender, RoutedPropertyChangedEventArgs<double> e)
            {
                this.scale.X = (float)(e.NewValue);
                this.scale.Y = (float)(e.NewValue);
            }
            ...
            private void primitiveListBox_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
            {
                int selectedIndex = this.primitiveListBox.SelectedIndex;

                if (selectedIndex < 0) { selectedIndex = 0; }
                if (selectedIndex >= this.primitives.Count) { selectedIndex = (this.primitives.Count - 1); }
                if (this.activePrimitive != null) { this.activePrimitive.Clear(); }

                this.activePrimitive = this.primitives[selectedIndex];
            }
        #endregion
        ...
        #region Transformation
            ...
            private void RotateObject(Polygon polygon)
            {
                ...
                float rotX = rotation.X * deg2rad;
                float rotY = rotation.Y * deg2rad;
                float rotZ = rotation.Z * deg2rad;

                float cosX = (float)(Math.Cos(rotX)); float sinX = (float)(Math.Sin(rotX));
                Mathematics.Matrix3x3 mX = new Mathematics.Matrix3x3(
                    Mathematics.Vector3D.UnitX,
                    new Mathematics.Vector3D(0.0f, cosX, -sinX),
                    new Mathematics.Vector3D(0.0f, sinX, cosX)
                );

                float cosY = (float)(Math.Cos(rotY)); float sinY = (float)(Math.Sin(rotY));
                Mathematics.Matrix3x3 mY = new Mathematics.Matrix3x3(
                    new Mathematics.Vector3D(cosY, 0.0f, sinY),
                    Mathematics.Vector3D.UnitY,
                    new Mathematics.Vector3D(-sinY, 0.0f, cosY)
                );

                float cosZ = (float)(Math.Cos(rotZ)); float sinZ = (float)(Math.Sin(rotZ));
                Mathematics.Matrix3x3 mZ = new Mathematics.Matrix3x3(
                    new Mathematics.Vector3D(cosZ, -sinZ, 0.0f),
                    new Mathematics.Vector3D(sinZ, cosZ, 0.0f),
                    Mathematics.Vector3D.UnitZ
                );

                Mathematics.Matrix3x3 mR = (mX * mY * mZ);
            ...
            private void TranslateObject(Polygon polygon)
            {
                for (int i = 0; i < polygon.vertices.Count; i++)
                {
                    polygon.modifiedVertices[i] += this.translation;
                }
            }

            private void ScaleObject(Polygon polygon)
            {
                Mathematics.Matrix3x3 m = new Mathematics.Matrix3x3(
                    new Mathematics.Vector3D(this.scale.X, 0.0f, 0.0f),
                    new Mathematics.Vector3D(0.0f, this.scale.Y, 0.0f),
                    new Mathematics.Vector3D(0.0f, 0.0f, this.scale.Z)
                );
        ...
        #region Update, Render, Present
            private void Update()
            {
                this.activePrimitive.Reset();
                if (this.isRotating) { this.rotation += this.rotationSpeed; }

                this.ObjectToWorld(this.activePrimitive);
                this.WorldToCamera(this.activePrimitive);
                this.CameraToScreen(this.activePrimitive);
            }

            private void Render()
            {
                this.ClearScreen(this.clearColor);
                this.DrawPolygon(this.activePrimitive);
            }

            private void Present()
            {
                this.buffers[this.renderBuffer].AddDirtyRect(this.bufferRegion);
                this.buffers[this.renderBuffer].Unlock();
                {
                    this.displayBuffer = this.renderBuffer++;
                    this.displaySurface.Source = this.buffers[this.displayBuffer];

                    if (this.renderBuffer == this.buffers.Length)
                    {
                        this.renderBuffer = 0;
                    }
                }
        ...
        #region Render Logic
            unsafe private void DrawPixel(float xPos, float yPos, Mathematics.Vector4D color)
            {
                int pixelIndex = (((int)(yPos) * this.pixelWidth) + (int)(xPos));

                if ((pixelIndex >= 0) && (pixelIndex < this.pixelCount))
                {
                    Mathematics.Vector4D* pRenderBuffer = (Mathematics.Vector4D*)(this.buffers[this.renderBuffer].BackBuffer);
                    pRenderBuffer[pixelIndex] = color;
                }
            }

            private void ClearScreen(Mathematics.Vector4D color)
            {
                for (int yPos = 0; yPos < this.pixelHeight; yPos++)
                {
                    for (int xPos = 0; xPos < this.pixelWidth; xPos++)
                    {
            ...
            private void DrawLine(Mathematics.Vector3D p1, Mathematics.Vector3D p2, Mathematics.Vector4D color)
            {
                ...
                int xDelta = (int)(xMax - xMin); int yDelta = (int)(yMax - yMin); int direction = 1;
                ...
                {
                    int pixelsPerStep = xDelta / yDelta; int initialPixelStep = (pixelsPerStep / 2) + 1; 
                    int adjustUp = (xDelta % yDelta) * 2; int adjustDown = (yDelta * 2);
                    ...
                    for (int pixelsDrawn = 0; pixelsDrawn < initialPixelStep; pixelsDrawn++)
                    {
                        this.DrawPixel(xPos, yPos, color);
                        xPos += direction;
                    }
                    ...
                    {
                        int runLength = pixelsPerStep; errorTerm += adjustUp;
                        if (errorTerm > 0) { runLength++; errorTerm -= adjustDown; }

                        for (int pixelsDrawn = 0; pixelsDrawn < runLength; pixelsDrawn++)
                        {
                            this.DrawPixel(xPos, yPos, color);
                            xPos += direction;
                        }
                ...
                {
                    int pixelsPerStep = yDelta / xDelta; int initialPixelStep = (pixelsPerStep / 2) + 1;
                    int adjustUp = (yDelta % xDelta) * 2; int adjustDown = xDelta * 2;
            ...
            private void DrawTriangle(Mathematics.Vector3D p1, Mathematics.Vector3D p2, Mathematics.Vector3D p3, Mathematics.Vector4D color)
            {
            ...
            private void DrawFace(Mathematics.Vector3D p1, Mathematics.Vector3D p2, Mathematics.Vector3D p3, Mathematics.Vector3D p4, Mathematics.Vector4D color)
            {
                this.DrawLine(p1, p2, color);
                this.DrawLine(p2, p3, color);
                ...
                if (this.isTriangles) { this.DrawLine(p2, p4, color); }
            }

            private void DrawPolygon(Polygon polygon)
            {
                for (int i = 0; i < polygon.verticeGroups.Count; i++)
                {
                    switch (polygon.verticeGroups[i].Length)
                    {
                        case 1:
                        {
                            if ((this.isCulling == false) || (this.ShouldCull(polygon, i) == false))
                            {
                                this.DrawPixel(polygon.modifiedVertices[polygon.verticeGroups[i][0]].X, polygon.modifiedVertices[polygon.verticeGroups[i][0]].Y, Mathematics.Vector4D.UnitW);
                            }
                            break;
                        }
                        ...
                        case 2:
                        {
                            if ((this.isCulling == false) || (this.ShouldCull(polygon, i) == false))
                            {
                                this.DrawLine(polygon.modifiedVertices[polygon.verticeGroups[i][0]], polygon.modifiedVertices[polygon.verticeGroups[i][1]], Mathematics.Vector4D.UnitW);
                            }
                            break;
                        }
                        ...
                        case 3:
                        {
                            if ((this.isCulling == false) || (this.ShouldCull(polygon, i) == false))
                            {
                                this.DrawTriangle(polygon.modifiedVertices[polygon.verticeGroups[i][0]], polygon.modifiedVertices[polygon.verticeGroups[i][1]], polygon.modifiedVertices[polygon.verticeGroups[i][2]], Mathematics.Vector4D.UnitW);
                            }
                            break;
                        }
                        ...
                        case 4:
                        {
                            if ((this.isCulling == false) || (this.ShouldCull(polygon, i) == false))
                            {
                                this.DrawFace(polygon.modifiedVertices[polygon.verticeGroups[i][0]], polygon.modifiedVertices[polygon.verticeGroups[i][1]], polygon.modifiedVertices[polygon.verticeGroups[i][2]], polygon.modifiedVertices[polygon.verticeGroups[i][3]], Mathematics.Vector4D.UnitW);
                            }
                            break;
                        }
            ...
            private bool ShouldCull(Polygon polygon, int index)
            {
                switch (polygon.normalGroups[index].Length)
                {
                    case 1:
                    {
                        Mathematics.Vector3D normal = (polygon.modifiedNormals[polygon.normalGroups[index][0]]);
                        normal /= normal.Length;
                        return this.ShouldCull(normal);
                    }

                    case 2:
                    {

                        Mathematics.Vector3D normal = (polygon.modifiedNormals[polygon.normalGroups[index][0]] + polygon.modifiedNormals[polygon.normalGroups[index][1]]);
                        normal /= normal.Length;
                        return this.ShouldCull(normal);
                    }
                    ...
                    case 3:
                    {
                        Mathematics.Vector3D normal = (polygon.modifiedNormals[polygon.normalGroups[index][0]] + polygon.modifiedNormals[polygon.normalGroups[index][1]] + polygon.modifiedNormals[polygon.normalGroups[index][2]]);
                        normal /= normal.Length;
                        return this.ShouldCull(normal);
                    }
                    ...
                    case 4:
                    {
                        Mathematics.Vector3D normal = (polygon.modifiedNormals[polygon.normalGroups[index][0]] + polygon.modifiedNormals[polygon.normalGroups[index][1]] + polygon.modifiedNormals[polygon.normalGroups[index][2]] + polygon.modifiedNormals[polygon.normalGroups[index][3]]);
                        normal /= normal.Length;
                        return this.ShouldCull(normal);
                    }
            ...
            private bool ShouldCull(Mathematics.Vector3D normal)
            {
                return Mathematics.Vector3D.DotProduct(normal, Mathematics.Vector3D.UnitZ) >= 0;
            }
        #endregion
    }
}

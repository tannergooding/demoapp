...
public struct Vector4 : IComparable, IComparable<Vector4>, IEquatable<Vector4>
{
    ...
    public readonly int CompareTo(object? obj)
    {
        return obj is Vector4 other
            ? CompareTo(other)
            : (obj is null) ? 1 : throw new ArgumentException($"{nameof(obj)} is not an instance of {nameof(Vector4)}", nameof(obj));
    }
    ...
    ///     </list>
    /// </returns>
    public readonly int CompareTo(Vector4 other) => Compare(this, other);
    ...
    public readonly bool Equals(Vector4 other) => Equals(this, other);
    ...
    public readonly Vector4 Normalize() => this / Length;
    ...
    public readonly Vector4 Transform(Matrix4x4 transformation)
    {
    ...
    public readonly Vector4 Transform(Quaternion rotation)
    {

...
/// <remarks>Initializes a new instance of the <see cref="Matrix3x3"/> struct.</remarks>
...
public struct Matrix3x3(Vector3 x, Vector3 y, Vector3 z) : IComparable, IComparable<Matrix3x3>, IEquatable<Matrix3x3>
{
    ...
    private Vector3 _x = x;
    private Vector3 _y = y;
    private Vector3 _z = z;
    ...
    public unsafe Vector3 this[int index]
    {
        get
        {
            return (uint)index > 2 ? throw new IndexOutOfRangeException() : Unsafe.Add(ref _x, index);
        }
    ...
    public readonly int CompareTo(object? obj)
    {
        return obj is Matrix3x3 other
            ? CompareTo(other)
            : (obj is null) ? 1 : throw new ArgumentException($"{nameof(obj)} is not an instance of {nameof(Matrix3x3)}", nameof(obj));
    }
    ...
    ///     </list>
    /// </returns>
    public readonly int CompareTo(Matrix3x3 other) => Compare(this, other);
    ...
    public readonly bool Equals(Matrix3x3 other) => Equals(this, other);
    ...
    public override readonly string ToString() => $"[{_x}, {_y}, {_z}]";
}

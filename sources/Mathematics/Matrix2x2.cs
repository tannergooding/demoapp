...
/// <remarks>Initializes a new instance of the <see cref="Matrix2x2"/> struct.</remarks>
...
public struct Matrix2x2(Vector2 x, Vector2 y) : IComparable, IComparable<Matrix2x2>, IEquatable<Matrix2x2>
{
    ...
    private Vector2 _x = x;
    private Vector2 _y = y;
    ...
    {
        return obj is Matrix2x2 other
            ? CompareTo(other)
            : (obj is null) ? 1 : throw new ArgumentException($"{nameof(obj)} is not an instance of {nameof(Matrix2x2)}", nameof(obj));
    }
    ...
    ///     </list>
    /// </returns>
    public readonly int CompareTo(Matrix2x2 other) => Compare(this, other);
    ...
    public readonly bool Equals(Matrix2x2 other) => Equals(this, other);

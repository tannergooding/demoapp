...
namespace Mathematics
{
    ...
    public struct Vector2 : IComparable, IComparable<Vector2>, IEquatable<Vector2>
    {
        ...
        public int CompareTo(object? obj)
        {
            ...
            return (obj is null) ? 1 : throw new ArgumentException($"{nameof(obj)} is not an instance of {nameof(Vector2)}", nameof(obj));
        }
        ...
        ///     </list>
        /// </returns>
        public int CompareTo(Vector2 other) => Compare(this, other);

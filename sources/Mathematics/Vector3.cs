...
public struct Vector3 : IComparable, IComparable<Vector3>, IEquatable<Vector3>
{
    ...
    public readonly int CompareTo(object? obj)
    {
        return obj is Vector3 other
            ? CompareTo(other)
            : (obj is null) ? 1 : throw new ArgumentException($"{nameof(obj)} is not an instance of {nameof(Vector3)}", nameof(obj));
    }
    ...
    ///     </list>
    /// </returns>
    public readonly int CompareTo(Vector3 other) => Compare(this, other);
    ...
    public readonly bool Equals(Vector3 other) => Equals(this, other);
    ...
    public readonly Vector3 Normalize() => this / Length;
    ...
    public readonly Vector3 Transform(Matrix3x3 transformation)
    {
    ...
    public readonly Vector3 Transform(Matrix4x4 transformation)
    {
        return new Vector3((_x * transformation.X.X) + (_y * transformation.Y.X) + (_z * transformation.Z.X),
                           (_x * transformation.X.Y) + (_y * transformation.Y.Y) + (_z * transformation.Z.Y),
                           (_x * transformation.X.Z) + (_y * transformation.Y.Z) + (_z * transformation.Z.Z));
    ...
    public readonly Vector3 Transform(Quaternion rotation)
    {

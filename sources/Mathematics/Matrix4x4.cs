...
/// <remarks>Initializes a new instance of the <see cref="Matrix4x4"/> struct.</remarks>
...
public struct Matrix4x4(Vector4 x, Vector4 y, Vector4 z, Vector4 w) : IComparable, IComparable<Matrix4x4>, IEquatable<Matrix4x4>
{
    ...
    private Vector4 _x = x;
    private Vector4 _y = y;
    private Vector4 _z = z;
    private Vector4 _w = w;
    ...
    public unsafe Vector4 this[int index]
    {
        get
        {
            return (uint)index > 3 ? throw new IndexOutOfRangeException() : Unsafe.Add(ref _x, index);
        }
    ...
    public readonly int CompareTo(object? obj)
    {
        return obj is Matrix4x4 other
            ? CompareTo(other)
            : (obj is null) ? 1 : throw new ArgumentException($"{nameof(obj)} is not an instance of {nameof(Matrix4x4)}", nameof(obj));
    }
    ...
    ///     </list>
    /// </returns>
    public readonly int CompareTo(Matrix4x4 other) => Compare(this, other);
    ...
    public readonly bool Equals(Matrix4x4 other) => Equals(this, other);
    ...
    public override readonly int GetHashCode() => Determinant.GetHashCode();

    public readonly Matrix4x4 Invert()
    {
        var a = _x.X;
        var b = _x.Y;
        var c = _x.Z;
    ...
    public override readonly string ToString() => $"[{_x}, {_y}, {_z}, {_w}]";
}
